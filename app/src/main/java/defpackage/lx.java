...
class lx {
    ...
    public lx(ProgressBar progressBar) {
        this.c = progressBar;
    }

    /* JADX WARN: Multi-variable type inference failed */
    final Drawable a(Drawable drawable, boolean z) {
        if (drawable instanceof adj) {
            adj adjVar = (adj) drawable;
            Drawable drawableA = adjVar.a();
            if (drawableA != null) {
                a(drawableA, z);
                adjVar.b();
                return drawable;
    ...
    public void b(AttributeSet attributeSet, int i) {
        ...
        rv rvVarF = rv.f(progressBar.getContext(), attributeSet, b, i, 0);
        ...
        if (drawableC != null) {
            ...
            progressBar.setIndeterminateDrawable(drawableC);
        }
        Drawable drawableC2 = rvVarF.c(1);
        if (drawableC2 != null) {
            progressBar.setProgressDrawable(a(drawableC2, false));
        }
        rvVarF.b.recycle();
    }
}
