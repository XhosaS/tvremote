...
public final class bqc {
  ...
  0x0062: PHI (r3v2 int) = (r3v1 int), (r3v1 int), (r3v1 int), (r3v3 int), (r3v3 int), (r3v3 int) binds: [B:6:0x0029, B:8:0x0031, B:10:0x0039, B:16:0x004d, B:18:0x0055, B:20:0x005d] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public bqc(java.lang.String r1, java.lang.String r2, boolean r3, int r4, java.lang.String r5, int r6) {
        /*
            r0 = this;
            r0.<init>()
            r0.a = r1
            ...
            boolean r2 = defpackage.agyv.o(r1, r2)
            if (r2 == 0) goto L22
            r1 = 3
            goto L63
        L22:
        ...
        L46:
            ...
            boolean r1 = defpackage.agyv.o(r1, r2)
            if (r1 == 0) goto L60
            goto L62
        L60:
            r1 = 1
        ...
        L63:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bqc.<init>(java.lang.String, java.lang.String, boolean, int, java.lang.String, int):void");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        bqc bqcVar = (bqc) obj;
        if (a() != bqcVar.a() || !agvy.c(this.a, bqcVar.a) || this.c != bqcVar.c) {
            return false;
        }
        String str = this.e;
        String str2 = bqcVar.e;
        int i = this.f;
        if (i == 1 && bqcVar.f == 2 && str != null && !bqi.e(str, str2)) {
            return false;
        }
        if (i == 2 && bqcVar.f == 1 && str2 != null && !bqi.e(str2, str)) {
            return false;
        }
        if (i == bqcVar.f) {
            if (str != null) {
