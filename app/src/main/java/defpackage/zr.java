...
public class zr extends ViewGroup.MarginLayoutParams {
    ...
    */
    public final void resolveLayoutDirection(int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.zr.resolveLayoutDirection(int):void");
    }

    public zr(Context context, AttributeSet attributeSet) throws NumberFormatException {
        ...
        this.av = new yn();
        this.aw = false;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, aag.b);
        int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = typedArrayObtainStyledAttributes.getIndex(i);
            int i2 = zq.a.get(index);
            switch (i2) {
                case 1:
                ...
                default:
                    switch (i2) {
                        case 44:
                            aac.h(this, typedArrayObtainStyledAttributes.getString(index));
                            break;
                        case 45:
                        ...
                        default:
                            switch (i2) {
                                case 64:
                                    aac.g(this, typedArrayObtainStyledAttributes, index, 0);
                                    this.E = true;
                                    break;
                                case 65:
                                    aac.g(this, typedArrayObtainStyledAttributes, index, 1);
                                    this.F = true;
                                    break;
                                case 66:
