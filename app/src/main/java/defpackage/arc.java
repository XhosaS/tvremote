...
public final class arc {
    ...
    public arc(arn arnVar, aqt aqtVar) {
        this.a = arnVar;
        this.b = aqtVar;
    }
    ...
    */
    public static boolean b(android.text.Editable r6, android.view.KeyEvent r7, boolean r8) {
        ...
        Lc:
            ...
            boolean r2 = e(r7, r1)
            if (r2 != 0) goto L47
            java.lang.Class<ard> r2 = defpackage.ard.class
        ...
        L47:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.arc.b(android.text.Editable, android.view.KeyEvent, boolean):boolean");
    }
    ...
    */
    public static boolean c(android.view.inputmethod.InputConnection r7, android.text.Editable r8, int r9, int r10, boolean r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.arc.c(android.view.inputmethod.InputConnection, android.text.Editable, int, int, boolean):boolean");
    }
    ...
    public final void a(Spannable spannable, aqz aqzVar, int i, int i2) {
        spannable.setSpan(new aro(aqzVar), i, i2, 33);
    }

    public final boolean d(CharSequence charSequence, int i, int i2, aqz aqzVar) {
        if (aqzVar.c == 0) {
            aqt aqtVar = this.b;
            bto btoVarA = aqzVar.a();
            int iE = btoVarA.e(8);
            if (iE != 0) {
                btoVarA.b.getShort(iE + btoVarA.a);
            }
            ThreadLocal threadLocal = ara.a;
            ...
            TextPaint textPaint = ((ara) aqtVar).b;
            String string = sb.toString();
            int i3 = act.a;
            aqzVar.c = true != textPaint.hasGlyph(string) ? 1 : 2;
        }
        return aqzVar.c == 2;
    }
}
