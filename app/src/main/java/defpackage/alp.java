...
public class alp {
    private static final Interpolator f = new all();
    public int a;
    public int b;
    public View d;
    ...
    public int c = -1;
    private final Runnable w = new alm(this);

    private alp(Context context, ViewGroup viewGroup, alo aloVar) {
        if (aloVar == null) {
        ...
        this.e = f;
        this.s = new OverScroller(context, new aln(this));
    }

    public static alp b(ViewGroup viewGroup, alo aloVar) {
        return new alp(viewGroup.getContext(), viewGroup, aloVar);
    }
    ...
    private final void r() {
        ...
        q(m(this.o.getXVelocity(this.c), this.q, f2), m(this.o.getYVelocity(this.c), this.q, f2));
    }

    private final void s(float f2, float f3, int i) {
        x(f2, f3, i);
        x(f3, f2, i);
        x(f2, f3, i);
        x(f3, f2, i);
    ...
    private final void t(float f2, float f3, int i) {
        float[] fArr = this.g;
    ...
    private final boolean v(View view, float f2, float f3) {
        if (view == null) {
            return false;
        }
        alo aloVar = this.t;
        boolean z = aloVar.a(view) > 0;
        boolean z2 = aloVar.h() > 0;
        if (!z || !z2) {
    ...
    public final void d(View view, int i) {
        ...
        ViewGroup viewGroup = this.v;
        if (parent != viewGroup) {
            throw new IllegalArgumentException(a.c(viewGroup, "captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (", ")"));
        }
        this.d = view;
        this.c = i;
        this.t.b(view, i);
    ...
    public final void e(MotionEvent motionEvent) {
        ...
        if (this.a == 1) {
            int i6 = this.c;
            if (!w(i6) || (iFindPointerIndex = motionEvent.findPointerIndex(i6)) == -1) {
                return;
            }
            ...
            while (i < pointerCount2) {
                ...
                if (w(pointerId5)) {
                    ...
                    if (v(viewA3, f4, f5) && k(viewA3, pointerId5)) {
                        break;
                    }
                }
                i++;
    ...
    public final boolean g(int i, int i2, int i3, int i4) {
        ...
        int i9 = (int) this.p;
        int iN = n(i3, i8, i9);
        int iN2 = n(i4, (int) this.q, i9);
        int iAbs = Math.abs(i7);
        int iAbs2 = Math.abs(i6);
        int iAbs3 = Math.abs(iN);
        int iAbs4 = Math.abs(iN2);
        int i10 = iAbs3 + iAbs4;
        int i11 = iAbs + iAbs2;
        if (iN != 0) {
            f2 = iAbs3 / i10;
        ...
        float f5 = f4 / f3;
        float fO = o(i7, iN, r13.a(view)) * f2;
        float fO2 = o(i6, iN2, this.t.h());
        this.e = f;
        this.s.startScroll(left, top, i7, i6, (int) (fO + (fO2 * f5)));
        f(2);
        return true;
    }
    ...
    */
    public final boolean j(android.view.MotionEvent r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.alp.j(android.view.MotionEvent):boolean");
    }
