...
public final class ijq extends iji implements wgt, aeiz, wjd, wwo {
    private iju b;
    private Context c;
    ...
    public final View D(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            hvh.a(logoView);
            logoView.d(10, true);
            View viewInflate = layoutInflater.inflate(R.layout.network_reauth_card, viewGroup2, false);
            ...
            aacVar.j(viewInflate.getId(), 6, 6, (int) ijuVarL.c.getResources().getDimension(R.dimen.amati_search_bar_text_margin_from_parent_start));
    ...
    @Override // defpackage.iji, defpackage.udh, defpackage.bq
    ...
    public final void aa(View view, Bundle bundle) {
        ...
        try {
            ...
            final iju ijuVarL = L();
            view.getClass();
            ghr ghrVar = ijuVarL.d;
            ycm ycmVar = ycm.a;
            ycl yclVar = new ycl();
            ygs.b(15, yclVar);
            ghrVar.ah(ygs.a(yclVar));
            View viewFindViewById = view.findViewById(R.id.network_reauth_verify_button);
            viewFindViewById.setOnClickListener(new View.OnClickListener() { // from class: ijs
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    ijuVarL.a(true);
                }
            });
            view.findViewById(R.id.network_reauth_decline_button).setOnClickListener(new View.OnClickListener() { // from class: ijt
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    ijuVarL.a(false);
                }
    ...
    @Override // defpackage.iji, defpackage.bq
    public final void ex(Context context) {
        ...
        try {
            ...
            if (this.b == null) {
                try {
                    wvx wvxVarD = wzg.d(ijq.class, "CreateComponent");
                    try {
                        Object objDN = cO().dN();
                        wvxVarD.close();
                        wvx wvxVarD2 = wzg.d(ijq.class, "CreatePeer");
                        try {
                            ...
                            if (!(bqVar instanceof ijq)) {
                                throw new IllegalStateException(a.B(bqVar, iju.class, "Attempt to inject a Fragment wrapper of type "));
                            }
                            ijq ijqVar = (ijq) bqVar;
                            ijqVar.getClass();
                            this.b = new iju(activity, context2, ijqVar, (gtu) eupVar.bE.a(), (ghr) eupVar.fg.a());
                            wvxVarD2.close();
