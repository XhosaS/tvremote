...
public class bik implements View.OnCreateContextMenuListener, MenuItem.OnMenuItemClickListener {
    private final Preference a;

    public bik(Preference preference) {
        this.a = preference;
    }
    ...
    public final void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
        ...
        if (!preference.y || TextUtils.isEmpty(charSequenceM)) {
            return;
        }
