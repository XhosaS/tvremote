...
public class ahza extends ICronetEngineBuilder {
    private static boolean a;
    private static boolean b;
    private final HttpEngine.Builder c;

    public ahza(HttpEngine.Builder builder) {
        this.c = builder;
    }
    ...
    public final ICronetEngineBuilder setExperimentalOptions(String str) {
        aicx aicxVar = new aicx(str);
        ConnectionMigrationOptions.Builder builder = new ConnectionMigrationOptions.Builder();
        builder.setDefaultNetworkMigration(a(aicxVar.k()));
        builder.setPathDegradationMigration(a(aicz.a((Boolean) aicxVar.f("QUIC", "allow_port_migration", null, Boolean.class))));
        int iJ = aicxVar.j();
        ...
        builder3.setAllowCrossNetworkUsage(a(aicxVar.l())).setUseStaleOnNameNotResolved(a(aicxVar.o()));
        DnsOptions.Builder builder4 = new DnsOptions.Builder();
        builder4.setUseHttpStackDnsResolver(a(aicxVar.i())).setStaleDns(a(aicxVar.m())).setStaleDnsOptions(builder3.build()).setPreestablishConnectionsToStaleDnsResults(a(aicz.a((Boolean) aicxVar.f("QUIC", "race_stale_dns_on_connection", null, Boolean.class)))).setPersistHostCache(a(aicxVar.n()));
        int iE = aicxVar.e();
        if (iE != -1) {
        ...
        if (aicxVar.g() != null) {
            for (String str2 : aicxVar.g().split(",")) {
        ...
        String str3 = (String) aicxVar.f("QUIC", "user_agent_id", null, String.class);
        if (str3 != null) {
