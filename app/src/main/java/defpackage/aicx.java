...
public final class aicx {
    public static final String a = "aicx";
    ...
    public final int i() {
        return aicz.a((Boolean) f("AsyncDNS", "enable", null, Boolean.class));
    }

    public final int j() {
        return aicz.a((Boolean) f("QUIC", "migrate_sessions_early_v2", null, Boolean.class));
    }

    public final int k() {
        return aicz.a((Boolean) f("QUIC", "migrate_sessions_on_network_change_v2", null, Boolean.class));
    }

    public final int l() {
        return aicz.a((Boolean) f("StaleDNS", "allow_other_network", null, Boolean.class));
    }

    public final int m() {
        return aicz.a((Boolean) f("StaleDNS", "enable", null, Boolean.class));
    }

    public final int n() {
        return aicz.a((Boolean) f("StaleDNS", "persist_to_disk", null, Boolean.class));
    }

    public final int o() {
        return aicz.a((Boolean) f("StaleDNS", "use_stale_on_name_not_resolved", null, Boolean.class));
    }
}
