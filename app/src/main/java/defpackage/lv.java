...
public class lv extends MultiAutoCompleteTextView {
    ...
    public lv(Context context, AttributeSet attributeSet) {
        ...
        rv rvVarF = rv.f(getContext(), attributeSet, a, com.google.android.katniss.R.attr.autoCompleteTextViewStyle, 0);
        ...
        this.b = leVar;
        leVar.d(attributeSet, com.google.android.katniss.R.attr.autoCompleteTextViewStyle);
        ms msVar = new ms(this);
        this.c = msVar;
        msVar.c(attributeSet, com.google.android.katniss.R.attr.autoCompleteTextViewStyle);
        msVar.a();
        lp lpVar = new lp(this);
        this.d = lpVar;
        lpVar.b(attributeSet, com.google.android.katniss.R.attr.autoCompleteTextViewStyle);
