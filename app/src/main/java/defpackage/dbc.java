...
public final class dbc extends FilterInputStream implements InputStreamRetargetInterface {
    private static final byte[] a = {-1, -31, 0, 28, 69, 120, 105, 102, 0, 0, 77, 77, 0, 0, 0, 0, 0, 8, 0, 1, 1, 18, 0, 2, 0, 0, 0, 1, 0};
    private static final int b = 31;
    private final byte c;
    private int d;

    public dbc(InputStream inputStream, int i) {
        super(inputStream);
        if (i < -1 || i > 8) {
            throw new IllegalArgumentException(a.b(i, "Cannot add invalid orientation: "));
        }
        this.c = (byte) i;
    }
