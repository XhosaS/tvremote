...
class lk implements qz {
    ...
    public final ColorStateList a(Context context, int i) {
        int iB = rq.b(context, R.attr.colorControlHighlight);
        return new ColorStateList(new int[][]{rq.a, rq.c, rq.b, rq.e}, new int[]{rq.a(context, R.attr.colorButtonNormal), acr.e(iB, i), acr.e(iB, i), i});
    }

    public final LayerDrawable b(ra raVar, Context context, int i) throws Resources.NotFoundException {
        BitmapDrawable bitmapDrawable;
        BitmapDrawable bitmapDrawable2;
        BitmapDrawable bitmapDrawable3;
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(i);
        Drawable drawableC = raVar.c(context, R.drawable.abc_star_black_48dp);
        Drawable drawableC2 = raVar.c(context, R.drawable.abc_star_half_black_48dp);
    ...
    public final void c(Drawable drawable, int i, PorterDuff.Mode mode) {
        ...
        drawableMutate.setColorFilter(ll.b(i, mode));
    }
