...
public class rq {
    ...
    public static int a(Context context, int i) {
        ...
        return acr.f(b(context, i), Math.round(Color.alpha(r4) * f2));
    }

    public static int b(Context context, int i) {
        int[] iArr = g;
        iArr[0] = i;
        rv rvVarE = rv.e(context, null, iArr);
        try {
            return rvVarE.b.getColor(0, 0);
        } finally {
            rvVarE.b.recycle();
        }
    }
    ...
    public static void d(View view, Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(hs.j);
        try {
