...
public class mdh extends ScheduledThreadPoolExecutor implements AutoCloseable {
    public mdh(ThreadFactory threadFactory) {
    ...
    protected final RunnableScheduledFuture decorateTask(Runnable runnable, RunnableScheduledFuture runnableScheduledFuture) {
        return mea.b(runnableScheduledFuture);
    }
