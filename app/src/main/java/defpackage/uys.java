...
public class uys extends alo {
    final /* synthetic */ SwipeDismissBehavior a;
    private int b;
    private int c = -1;

    public uys(SwipeDismissBehavior swipeDismissBehavior) {
    ...
    */
    public final void d(android.view.View r6, float r7, float r8) {
        ...
        L74:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.uys.d(android.view.View, float, float):void");
    }
    ...
    public final void i(View view, int i, int i2) {
        ...
        if (fAbs <= f) {
            ...
            view.setAlpha(SwipeDismissBehavior.t(1.0f - ((fAbs - f) / (width2 - f))));
        }
    }
