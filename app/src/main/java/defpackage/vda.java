...
public class vda extends AppCompatTextView {
    public vda(Context context, AttributeSet attributeSet) throws Resources.NotFoundException {
        super(vdc.a(context, attributeSet, R.attr.textViewStyle, 0), attributeSet, R.attr.textViewStyle);
    ...
    private final void b(Resources.Theme theme, int i) throws Resources.NotFoundException {
        TypedArray typedArrayObtainStyledAttributes = theme.obtainStyledAttributes(i, vdb.a);
    ...
    private static boolean c(Context context) {
        return vaz.c(context, com.google.android.katniss.R.attr.textAppearanceLineHeightEnabled, true);
    }
