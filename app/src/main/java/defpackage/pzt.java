...
public final class pzt implements aejg {
    private final pzq a;
    ...
    public pzt(pzq pzqVar, aejl aejlVar, aejl aejlVar2, aejl aejlVar3, aejl aejlVar4, aejl aejlVar5, aejl aejlVar6) {
        this.a = pzqVar;
        this.b = aejlVar;
        this.c = aejlVar2;
        this.d = aejlVar3;
    ...
    public final /* bridge */ /* synthetic */ Object a() {
        ...
        ujlVarH.f(false);
        pzq pzqVar = this.a;
        ujlVarH.b().g(qen.a(context, pzqVar.a, qbvVar, pvxVarA, yqtVar));
