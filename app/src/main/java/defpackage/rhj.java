...
public final class rhj implements Comparable {
    final long a;
    final String b;
    public final int c;
    public final long d;
    ...
    public rhj(long j, String str, int i, long j2, Object obj) {
        yqw.A(((j > 0L ? 1 : (j == 0L ? 0 : -1)) == 0) == (str != null));
        this.a = j;
        this.b = str;
        this.c = i;
        this.d = j2;
        ...
        } else if ((obj instanceof byte[]) || (obj instanceof abvo)) {
            this.f = null;
        } else {
    ...
    public final Object b() {
        ...
        obj2.getClass();
        try {
            return obj2 instanceof byte[] ? (byte[]) obj2 : ((abvo) obj2).B();
        } catch (Throwable th) {
    ...
    public final boolean equals(Object obj) {
        ...
        rhj rhjVar = (rhj) obj;
        return this.a == rhjVar.a && Objects.equals(this.b, rhjVar.b);
    }
