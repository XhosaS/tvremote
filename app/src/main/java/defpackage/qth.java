...
public final class qth {
    ...
    public static qtk a(Context context, String str) {
        qte qteVar;
        try {
            ...
            if (runningAppProcesses == null) {
                int i = yyk.e;
                qteVar = new qte(false, zcg.b);
            } else {
                qteVar = new qte(true, yyk.j(runningAppProcesses));
            }
            return qteVar;
        } finally {
            Trace.endSection();
    ...
    */
    public static java.lang.String b() throws java.lang.Throwable {
        /*
            java.lang.String r0 = defpackage.qth.c
            if (r0 == 0) goto L5
            goto L40
        L5:
        ...
        Ld:
            ...
            java.lang.String r0 = defpackage.a.a(r0, r4, r5)     // Catch: java.lang.Throwable -> L31 java.io.IOException -> L38
        ...
        L40:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.qth.b():java.lang.String");
    }
    ...
    public static boolean d(Context context, qtk qtkVar) {
        if (!qtkVar.b()) {
            return false;
        }
        yyk<ActivityManager.RunningAppProcessInfo> yykVarC = qtkVar.c();
        String packageName = context.getPackageName();
        String strValueOf = String.valueOf(packageName);
        for (ActivityManager.RunningAppProcessInfo runningAppProcessInfo : yykVarC) {
