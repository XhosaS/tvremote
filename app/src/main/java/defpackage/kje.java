...
public final class kje {
    ...
    public static String a(Context context) {
        ...
        try {
            Context context2 = kmb.a.a(context).a;
    ...
    public static String b(Context context, int i) {
        ...
        if (i == 2) {
            return kll.e(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, strA);
        }
        if (i == 3) {
    ...
    public static String c(Context context, int i) {
        ...
        switch (i) {
            ...
            case 19:
            default:
                Log.e("GoogleApiAvailability", a.b(i, "Unexpected error code "));
                return null;
            case 16:
    ...
    public static String e(Context context, String str) {
        ...
        wx wxVar = a;
        synchronized (wxVar) {
            Locale locale = ads.b(context.getResources().getConfiguration().getLocales()).b.a.get(0);
            if (!locale.equals(b)) {
                wxVar.clear();
                b = locale;
            }
            String str2 = (String) wxVar.get(str);
            if (str2 != null) {
                return str2;
            }
            int i = kdt.a;
            ...
            if (identifier == 0) {
                Log.w("GoogleApiAvailability", a.j(str, "Missing resource: "));
                return null;
            }
            String string = resourcesForApplication.getString(identifier);
            if (TextUtils.isEmpty(string)) {
                Log.w("GoogleApiAvailability", a.j(str, "Got empty resource: "));
                return null;
            }
            a.put(str, string);
            return string;
