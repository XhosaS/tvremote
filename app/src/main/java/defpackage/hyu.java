...
public final class hyu extends hyr {
    public hyu(hzk hzkVar, hzd hzdVar, hzf hzfVar) {
    ...
    public final hze a(hzg hzgVar) {
        ...
        switch (iOrdinal) {
            ...
            case 15:
                ...
                searchBar.n(searchBar.getIdlePromptId(), true);
                return this;
            case 16:
    ...
    public final void m() {
        SearchBar searchBar = (SearchBar) this.b;
        searchBar.k(searchBar.getIdlePromptId(), true);
        this.b.q();
        this.b.u(10, false);
    }
