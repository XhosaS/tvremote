...
public final class ahmf {
    ...
    static {
        ...
        try {
            objA = Class.forName("agto").getCanonicalName();
        } catch (Throwable th) {
            objA = agpl.a(th);
        }
        if (agpk.a(objA) != null) {
        ...
        b = (String) objA;
        try {
            objA2 = Class.forName("ahmf").getCanonicalName();
        } catch (Throwable th2) {
            objA2 = agpl.a(th2);
        }
    ...
    */
    public static final java.lang.Throwable a(java.lang.Throwable r10, defpackage.agtr r11) {
        /*
            Method dump skipped, instructions count: 276
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ahmf.a(java.lang.Throwable, agtr):java.lang.Throwable");
    }

    public static final Throwable b(Throwable th) {
        Throwable thA;
        if (!ahbx.b || (thA = ahlm.a(th)) == null) {
            return th;
        }
        ...
        if (i >= 0) {
            while (true) {
                int i2 = i - 1;
                if (agvy.c(c, stackTrace[i].getClassName())) {
                    break;
                }
                if (i2 < 0) {
                    break;
    ...
    public static final Throwable c(Throwable th) {
        ...
        if (cause != null) {
            if (agvy.c(cause.getClass(), th.getClass())) {
    ...
    private static final int e(StackTraceElement[] stackTraceElementArr, String str) {
        ...
        for (int i = 0; i < length; i++) {
            if (agvy.c(str, stackTraceElementArr[i].getClassName())) {
                return i;
            }
        }
        return -1;
