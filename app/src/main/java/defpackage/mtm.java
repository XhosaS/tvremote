...
class mtm implements obw {
    ...
    public mtm(mtx mtxVar, ogq ogqVar, obz obzVar, nzw nzwVar, oal oalVar) {
        this.a = ogqVar;
        this.b = obzVar;
        this.c = nzwVar;
        this.d = oalVar;
    ...
    public final void a(View view, ofs ofsVar) {
        ...
        nzw nzwVar = this.c;
        oal oalVar = this.d;
        nzx nzxVarG = mtx.g(view, null, 17, ofsVar, senderStateOuterClass$SenderStateH, obzVar, nzwVar, oalVar, null);
        mtx mtxVar = this.e;
