...
public final class ztg {
    private static final yqd a = new ypz('.');
    private static final yqd b = new ypz(':');
    ...
    public static InetAddress a(String str) {
        ztf ztfVar = new ztf();
        byte[] bArrB = b(str, ztfVar);
        if (bArrB != null) {
            return d(bArrB, ztfVar.a);
        }
    ...
    */
    public static byte[] b(java.lang.String r13, defpackage.ztf r14) {
        /*
            Method dump skipped, instructions count: 353
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ztg.b(java.lang.String, ztf):byte[]");
    }
    ...
    private static InetAddress d(byte[] bArr, String str) throws SocketException, UnknownHostException {
        try {
            ...
            yqw.B(byAddress instanceof Inet6Address, "Unexpected state, scope should only appear for ipv6");
            ...
            try {
                ...
                throw new IllegalArgumentException(a.j(str, "No such interface: "), e);
            }
