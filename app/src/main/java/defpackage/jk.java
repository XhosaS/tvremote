...
class jk implements DialogInterface.OnKeyListener, DialogInterface.OnClickListener, DialogInterface.OnDismissListener, jv {
    public final jj a;
    public gc b;
    jf c;
    ...
    public final void a(jj jjVar, boolean z) {
        gc gcVar;
        if ((z || jjVar == this.a) && (gcVar = this.b) != null) {
            gcVar.dismiss();
        }
    }
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        this.a.x(((je) this.c.a()).getItem(i), null, 0);
    }
    ...
    */
    public final boolean onKey(android.content.DialogInterface r3, int r4, android.view.KeyEvent r5) {
        ...
        L5c:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.jk.onKey(android.content.DialogInterface, int, android.view.KeyEvent):boolean");
    }
}
