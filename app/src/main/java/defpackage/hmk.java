...
class hmk extends bq implements aeja {
    ...
    protected final void aB() {
        ...
        hmlVar.a = eupVar.bj();
        etb etbVar = ethVar.c;
        hmlVar.b = fgu.a.a(etbVar.e);
        Activity activity = etbVar.a;
        aeiv.a(activity);
        hmlVar.c = fgv.b(activity);
        hmlVar.d = (wke) ethVar.e.a();
        hmlVar.e = eupVar.C();
        hmlVar.f = ethVar.f;
        hmlVar.ah = (ghr) eupVar.fg.a();
        hmlVar.ai = (gnj) eupVar.fo.a();
    }
