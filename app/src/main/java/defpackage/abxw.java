...
public final class abxw extends InputStream implements InputStreamRetargetInterface {
    private Iterator a;
    ...
    public final int read() {
        ...
        int iA = acah.a.a(this.e + this.i) & 255;
        a(1);
        return iA;
    }
