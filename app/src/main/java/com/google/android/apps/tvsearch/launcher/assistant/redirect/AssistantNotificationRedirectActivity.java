...
public final class AssistantNotificationRedirectActivity extends gax implements wgt, wgr, wip {
    private gat m;
    private boolean o;
    private Context p;
    private bco r;
    ...
    public AssistantNotificationRedirectActivity() {
        this.f.a(new gas(this));
    }
            ...
            try {
                ...
                try {
                    try {
                        ...
                        aeiv.a(activity);
                        if (!(activity instanceof AssistantNotificationRedirectActivity)) {
                            throw new IllegalStateException(a.w((tt) activity, gat.class));
                        }
                        eup eupVar = ((etb) objDN).c;
                        this.m = new gat((AssistantNotificationRedirectActivity) activity, (gtu) eupVar.bE.a(), (ghr) eupVar.fg.a());
                        wvxVarF.close();
    ...
    @Override // defpackage.gax, defpackage.bw, defpackage.tt, defpackage.eq, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            D();
            gat gatVar = this.m;
            AssistantNotificationRedirectActivity assistantNotificationRedirectActivity = gatVar.b;
            if (!assistantNotificationRedirectActivity.getIntent().hasExtra("notification_type")) {
                ((zdv) ((zdv) gat.a.c()).q("com/google/android/apps/tvsearch/launcher/assistant/redirect/AssistantNotificationRedirectActivityPeer", "maybeSendRedirectIntent", 65, "AssistantNotificationRedirectActivityPeer.java")).u("Intent extra \"notification_type\" is required.");
            } else if ("as_voice_input_disable_notification".equals(assistantNotificationRedirectActivity.getIntent().getStringExtra("notification_type"))) {
                gatVar.d.ai(3);
                Intent intent = new Intent("android.settings.SLICE_SETTINGS");
                Account accountC = gatVar.c.c();
                intent.putExtra("slice_uri", "content://com.google.android.katniss.sliceprovider.AssistantSettingsSliceProvider/general/".concat(String.valueOf(accountC != null ? accountC.name : "")));
                wyo.l(assistantNotificationRedirectActivity, intent);
            } else {
                ((zdv) ((zdv) gat.a.c()).q("com/google/android/apps/tvsearch/launcher/assistant/redirect/AssistantNotificationRedirectActivityPeer", "maybeSendRedirectIntent", 82, "AssistantNotificationRedirectActivityPeer.java")).u("No valid notification_type extra is found.");
            }
            assistantNotificationRedirectActivity.finish();
            this.o = false;
            wszVar.o();
            ((wsx) wwtVarV).a.t();
        } catch (Throwable th) {
    ...
    @Override // defpackage.gax, defpackage.gf, defpackage.bw, android.app.Activity
