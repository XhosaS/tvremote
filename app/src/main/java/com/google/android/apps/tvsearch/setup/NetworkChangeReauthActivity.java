...
public final class NetworkChangeReauthActivity extends igm implements wgt, wgr, wip {
    private igr m;
    private boolean o;
    private Context p;
    private bco r;
    ...
    public NetworkChangeReauthActivity() {
        this.f.a(new igq(this));
    }
            ...
            try {
                ...
                try {
                    try {
                        ...
                        aeiv.a(activity);
                        if (!(activity instanceof NetworkChangeReauthActivity)) {
                            throw new IllegalStateException(a.w((tt) activity, igr.class));
                        }
                        this.m = new igr((NetworkChangeReauthActivity) activity);
                        wvxVarF.close();
    ...
    @Override // defpackage.igm, defpackage.bw, defpackage.tt, defpackage.eq, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            M();
            NetworkChangeReauthActivity networkChangeReauthActivity = this.m.a;
            networkChangeReauthActivity.setContentView(R.layout.network_reauth);
            if (bundle == null) {
                ab abVar = new ab(((bw) networkChangeReauthActivity).a.a.e);
                abVar.s = true;
                abVar.f(R.id.network_reauth_fragment_container_view, abVar.o(ijq.class), null, 1);
                abVar.e();
            }
            this.o = false;
            wszVar.o();
    ...
    @Override // defpackage.igm, defpackage.gf, defpackage.bw, android.app.Activity
