package com.google.android.apps.tvsearch.preferences.activity;
...
public final class GoogleSettingsActivity extends han implements wgt, wgr, wip {
    private hal m;
    private boolean o;
    private Context p;
    private bco r;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        aeiv.a(activity);
                        if (!(activity instanceof GoogleSettingsActivity)) {
                            throw new IllegalStateException(a.w((tt) activity, hal.class));
                        }
                        eup eupVar = ((etb) objDN).c;
                        this.m = new hal((GoogleSettingsActivity) activity, (ahbt) eupVar.q.a(), eupVar.fj, eupVar.fi);
                        wvxVarF.close();
    ...
    @Override // defpackage.han, defpackage.bw, defpackage.tt, defpackage.eq, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            D();
            hal halVar = this.m;
            if (!((Boolean) halVar.d.a()).booleanValue()) {
                ahal.e(halVar.b, null, 0, new hak(halVar, null), 3);
            }
            ab abVar = new ab(((bw) halVar.a).a.a.e);
            hbb hbbVar = new hbb();
            aeik.d(hbbVar);
            abVar.q(R.id.content, hbbVar, null);
            abVar.e();
            this.o = false;
            wszVar.o();
            ((wsx) wwtVarV).a.t();
    ...
    @Override // defpackage.han, defpackage.gf, defpackage.bw, android.app.Activity
