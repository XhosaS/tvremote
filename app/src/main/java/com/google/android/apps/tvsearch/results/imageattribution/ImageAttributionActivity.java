...
public final class ImageAttributionActivity extends hkd implements wgt, wgr, wip {
    private hkg m;
    private boolean o;
    private Context p;
    private bco r;
    ...
    public ImageAttributionActivity() {
        this.f.a(new hkf(this));
    }
            ...
            try {
                ...
                try {
                    try {
                        ...
                        aeiv.a(activity);
                        if (!(activity instanceof ImageAttributionActivity)) {
                            throw new IllegalStateException(a.w((tt) activity, hkg.class));
                        }
                        this.m = new hkg((ImageAttributionActivity) activity);
                        wvxVarF.close();
    ...
    @Override // defpackage.hkd, defpackage.bw, defpackage.tt, defpackage.eq, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            M();
            ImageAttributionActivity imageAttributionActivity = this.m.a;
            Bundle extras = imageAttributionActivity.getIntent().getExtras();
            if (extras == null) {
                imageAttributionActivity.finish();
            } else {
                imageAttributionActivity.setContentView(R.layout.keyboard_image_attribution_main);
                hki hkiVar = new hki();
                hkiVar.ae(new Bundle(extras));
                ab abVar = new ab(((bw) imageAttributionActivity).a.a.e);
                abVar.q(R.id.image_attribution_fragment_container, hkiVar, null);
                abVar.e();
            }
            this.o = false;
            wszVar.o();
    ...
    @Override // defpackage.hkd, defpackage.gf, defpackage.bw, android.app.Activity
