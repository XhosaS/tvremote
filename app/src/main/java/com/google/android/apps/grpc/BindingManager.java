...
final class BindingManager implements ServiceConnection {
    ...
    private final BinderDiedReceiver diedReceiver;
    private final List pendingReceivers = new ArrayList();
    private boolean haveBinding = false;
    ...
    /* compiled from: PG */
    public interface BinderDiedReceiver {
        void onBinderDied();
    }
    ...
    class MainThreadHandler extends Handler {
        ...
        final /* synthetic */ BindingManager this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public MainThreadHandler(BindingManager bindingManager) {
        ...
        public void handleMessage(Message message) {
            ...
            if (message.what == 1) {
                this.this$0.unbindOnMainThread();
            }
        }
    ...
    public BindingManager(Context context, Intent intent, BinderConverter binderConverter, BinderDiedReceiver binderDiedReceiver) {
        this.context = context;
        this.bindIntent = intent;
        this.converter = binderConverter;
        this.diedReceiver = binderDiedReceiver;
    }
    ...
    public boolean bindService() {
        ...
        try {
            ...
            this.haveBinding = zBindService;
            return zBindService;
        } catch (SecurityException e) {
            this.haveBinding = false;
            Log.e(TAG, "embedder does not have permission to bind to the service".concat(String.valueOf(e.toString())));
            return false;
        }
    }
    ...
    public void onBindingDied(ComponentName componentName) {
        ...
        unbind();
        this.diedReceiver.onBinderDied();
        updateReceivers();
    }
    ...
    public void with(BinderReceiver binderReceiver) {
        Log.d(TAG, "with");
