...
public final class JitHotwordSetupActivity extends igk implements wgt, wgr, wip {
    private igp m;
    private boolean o;
    private Context p;
    private bco r;
    ...
    public JitHotwordSetupActivity() {
        this.f.a(new ign(this));
    }
            ...
            try {
                ...
                try {
                    try {
                        ...
                        aeiv.a(activity);
                        if (!(activity instanceof JitHotwordSetupActivity)) {
                            throw new IllegalStateException(a.w((tt) activity, igp.class));
                        }
                        this.m = new igp((JitHotwordSetupActivity) activity, ((etb) objDN).c.ho());
                        wvxVarF.close();
    ...
    @Override // defpackage.igk, defpackage.bw, defpackage.tt, defpackage.eq, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            M();
            igp igpVar = this.m;
            JitHotwordSetupActivity jitHotwordSetupActivity = igpVar.b;
            jitHotwordSetupActivity.setContentView(R.layout.setup_hotword_amati);
            Intent intent = jitHotwordSetupActivity.getIntent();
            if (intent == null || (extras = intent.getExtras()) == null || !extras.getBoolean("START_FARFIELD_MIC_EDUCATION_SCREEN", false)) {
                if (bundle == null) {
                    ab abVar = new ab(((bw) jitHotwordSetupActivity).a.a.e);
                    abVar.s = true;
                    abVar.f(R.id.fragment_container_view, abVar.o(iod.class), null, 1);
                    abVar.e();
                }
            } else if (igpVar.c) {
                igpVar.d.b(new Intent("com.google.assistant.GOOGLE_HOTWORD_SETUP"));
            } else {
                ab abVar2 = new ab(((bw) jitHotwordSetupActivity).a.a.e);
                abVar2.s = true;
                abVar2.f(R.id.fragment_container_view, abVar2.o(inz.class), null, 1);
                abVar2.e();
            }
            this.o = false;
            wszVar.o();
    ...
    @Override // defpackage.igk, defpackage.gf, defpackage.bw, android.app.Activity
