package com.google.android.apps.tvsearch.launcher.assistant.redirect;
...
public final class TvOperatorDiagnosticRedirectActivity extends gaz implements wgt, wgr, wip {
    private gbc m;
    private boolean o;
    private Context p;
    private bco r;
    ...
    public TvOperatorDiagnosticRedirectActivity() {
        this.f.a(new gba(this));
    }
            ...
            try {
                ...
                try {
                    try {
                        ...
                        aeiv.a(activity);
                        if (!(activity instanceof TvOperatorDiagnosticRedirectActivity)) {
                            throw new IllegalStateException(a.w((tt) activity, gbc.class));
                        }
                        eup eupVar = ((etb) objDN).c;
                        this.m = new gbc((TvOperatorDiagnosticRedirectActivity) activity, eupVar.nU, (ffk) eupVar.fu.a());
                        wvxVarF.close();
                        this.m.f = this;
    ...
    @Override // defpackage.gaz, defpackage.bw, defpackage.tt, defpackage.eq, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            M();
            gbc gbcVar = this.m;
            if (((Boolean) gbcVar.c.a()).booleanValue()) {
                TvOperatorDiagnosticRedirectActivity tvOperatorDiagnosticRedirectActivity = gbcVar.b;
                if (tvOperatorDiagnosticRedirectActivity.getIntent().hasExtra("tv_operator_status")) {
                    String strValueOf = String.valueOf(tvOperatorDiagnosticRedirectActivity.getIntent().getStringExtra("tv_operator_status"));
                    xkc xkcVar = xkc.a;
                    xkb xkbVar = new xkb();
                    ...
                    strValueOf.getClass();
                    xkcVar2.b = 1 | xkcVar2.b;
                    xkcVar2.c = strValueOf;
                    abxd abxdVarV = xkbVar.v();
                    abxdVarV.getClass();
                    ((zdv) gbc.a.b().q("com/google/android/apps/tvsearch/launcher/assistant/redirect/TvOperatorDiagnosticRedirectActivityPeer", "onCreate", 60, "TvOperatorDiagnosticRedirectActivityPeer.kt")).u("Start custom tap input");
                    gbcVar.d.s((xkc) abxdVarV);
                    if (gbcVar.e == null) {
                        gbcVar.e = new gbb(gbcVar);
                    }
                    IntentFilter intentFilter = new IntentFilter();
                    intentFilter.addAction("android.katniss.search.action.CONVERSATION_IS_ENDED");
                    abs.c(tvOperatorDiagnosticRedirectActivity, gbcVar.e, intentFilter, "com.google.android.assistant.CONVERSATION_ENDED_BROADCAST", 4);
                } else {
                    ((zdv) gbc.a.d().q("com/google/android/apps/tvsearch/launcher/assistant/redirect/TvOperatorDiagnosticRedirectActivityPeer", "onCreate", 53, "TvOperatorDiagnosticRedirectActivityPeer.kt")).u("tv_operator_status extra not found");
                    tvOperatorDiagnosticRedirectActivity.finish();
                }
            } else {
                ((zdv) gbc.a.b().q("com/google/android/apps/tvsearch/launcher/assistant/redirect/TvOperatorDiagnosticRedirectActivityPeer", "onCreate", 47, "TvOperatorDiagnosticRedirectActivityPeer.kt")).u("Invalid user");
                gbcVar.b.finish();
            }
            this.o = false;
            wszVar.o();
    ...
    @Override // defpackage.gaz, defpackage.gf, defpackage.bw, android.app.Activity
    public final void onDestroy() {
        wwt wwtVarD = this.n.d();
        try {
            M();
            gbc gbcVar = this.m;
            BroadcastReceiver broadcastReceiver = gbcVar.e;
            if (broadcastReceiver != null) {
                gbcVar.b.unregisterReceiver(broadcastReceiver);
                gbcVar.e = null;
            }
            super.onDestroy();
            this.s = true;
