package com.google.android.apps.tvsearch.results.web.webview;
...
public final class WebViewActivity extends huh implements wgt, wgr, wip {
    private huk m;
    private boolean o;
    private Context p;
    private bco r;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof WebViewActivity)) {
                            throw new IllegalStateException(a.w((tt) activity, huk.class));
                        }
                        this.m = new huk((WebViewActivity) activity);
                        wvxVarF.close();
    ...
    @Override // defpackage.huh, defpackage.bw, defpackage.tt, defpackage.eq, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            M();
            WebViewActivity webViewActivity = this.m.b;
            Bundle extras = webViewActivity.getIntent().getExtras();
            if (extras == null) {
                ((zdv) ((zdv) huk.a.c()).q("com/google/android/apps/tvsearch/results/web/webview/WebViewActivityPeer", "onCreate", 31, "WebViewActivityPeer.java")).u("Bundle with arguments for Fragment are missing");
                webViewActivity.finish();
            } else {
                FrameLayout frameLayout = new FrameLayout(webViewActivity);
                int iGenerateViewId = FrameLayout.generateViewId();
                frameLayout.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
                frameLayout.setId(iGenerateViewId);
                webViewActivity.setContentView(frameLayout);
                huo huoVar = new huo();
                huoVar.ae(extras);
                ab abVar = new ab(((bw) webViewActivity).a.a.e);
                abVar.q(iGenerateViewId, huoVar, null);
                abVar.e();
            }
            this.o = false;
            wszVar.o();
    ...
    @Override // defpackage.huh, defpackage.gf, defpackage.bw, android.app.Activity
