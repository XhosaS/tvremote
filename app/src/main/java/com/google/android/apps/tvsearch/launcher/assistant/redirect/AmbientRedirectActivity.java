...
public final class AmbientRedirectActivity extends gav implements wgt, wgr, wip {
    private gar m;
    private boolean o;
    private Context p;
    private bco r;
    ...
    public AmbientRedirectActivity() {
        this.f.a(new gal(this));
    }
        ...
        try {
            ...
            try {
                try {
                    ...
                    aeiv.a(activity);
                    if (!(activity instanceof AmbientRedirectActivity)) {
                        throw new IllegalStateException(a.w((tt) activity, gar.class));
                    }
                    eup eupVar = ((etb) objDN).c;
                    Context context = (Context) eupVar.n.a();
                    agte agteVar = (agte) eupVar.bW.a();
                    ahbt ahbtVar = (ahbt) eupVar.q.a();
                    aejl aejlVar = eupVar.fA;
                    kdv kdvVarA = kdv.a((Context) eupVar.n.a());
                    kdvVarA.getClass();
                    this.m = new gar((AmbientRedirectActivity) activity, context, agteVar, ahbtVar, aejlVar, kdvVarA, new ewo(), eupVar.cp, (exz) eupVar.gG.a(), (ffk) eupVar.fu.a(), eupVar.lx, eupVar.ab(), (ztw) eupVar.ao.a());
                    wvxVarF.close();
    ...
    @Override // defpackage.gav, defpackage.bw, defpackage.tt, defpackage.eq, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            D();
            gar garVar = this.m;
            AmbientRedirectActivity ambientRedirectActivity = garVar.b;
            if (ambientRedirectActivity.getIntent().hasExtra("server_token")) {
                if (((Boolean) garVar.f.a()).booleanValue()) {
                    agow agowVar = garVar.h;
                    ((gfn) agowVar.a()).b(rpm.p()).b().c();
                    ((gfn) agowVar.a()).a(rpm.a()).b().c();
                }
                try {
                    byte[] bArrJ = zkl.e.j(String.valueOf(ambientRedirectActivity.getIntent().getStringExtra("server_token")));
                    xgw xgwVar = xgw.a;
                    int length = bArrJ.length;
                    ExtensionRegistryLite extensionRegistryLite = ExtensionRegistryLite.a;
                    abza abzaVar = abza.a;
                    abxd abxdVarH = abxd.h(xgwVar, bArrJ, 0, length, ExtensionRegistryLite.a);
                    ...
                    xgw xgwVar2 = (xgw) abxdVarH;
                    xgwVar2.getClass();
                    ahal.e(garVar.e, null, 0, new gao(garVar, xgwVar2, null), 3);
                } catch (Exception e) {
                    ((zdv) ((zdv) gar.a.d()).p(e).q("com/google/android/apps/tvsearch/launcher/assistant/redirect/AmbientRedirectActivityPeer", "onCreate", 123, "AmbientRedirectActivityPeer.kt")).u("failed to parse serverTokenBytes");
                    garVar.b.finish();
                }
            } else {
                ((zdv) gar.a.d().q("com/google/android/apps/tvsearch/launcher/assistant/redirect/AmbientRedirectActivityPeer", "onCreate", 99, "AmbientRedirectActivityPeer.kt")).u("Server token not found");
                ambientRedirectActivity.finish();
            }
            this.o = false;
            this.n.o();
            ((wsx) wwtVarV).a.t();
    ...
    @Override // defpackage.gav, defpackage.gf, defpackage.bw, android.app.Activity
    public final void onDestroy() {
        ...
        try {
            ...
            D();
            gar garVar = this.m;
            BroadcastReceiver broadcastReceiver = garVar.n;
            if (broadcastReceiver != null) {
                garVar.c.unregisterReceiver(broadcastReceiver);
                garVar.n = null;
            }
            garVar.q.b(garVar.b);
            this.s = true;
