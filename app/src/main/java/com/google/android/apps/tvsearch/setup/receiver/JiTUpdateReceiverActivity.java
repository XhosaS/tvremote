package com.google.android.apps.tvsearch.setup.receiver;
...
public final class JiTUpdateReceiverActivity extends ipu implements wgt, wgr, wip {
    private ipw m;
    private boolean o;
    private Context p;
    private bco r;
    ...
    public JiTUpdateReceiverActivity() {
        this.f.a(new ipv(this));
    }
            ...
            try {
                ...
                try {
                    try {
                        ...
                        aeiv.a(activity);
                        if (!(activity instanceof JiTUpdateReceiverActivity)) {
                            throw new IllegalStateException(a.w((tt) activity, ipw.class));
                        }
                        eup eupVar = ((etb) objDN).c;
                        this.m = new ipw((JiTUpdateReceiverActivity) activity, (gtu) eupVar.bE.a(), (idl) eupVar.ga.a());
                        wvxVarF.close();
    ...
    @Override // defpackage.ipu, defpackage.bw, defpackage.tt, defpackage.eq, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            M();
            ipw ipwVar = this.m;
            JiTUpdateReceiverActivity jiTUpdateReceiverActivity = ipwVar.b;
            if (agvy.c("com.google.android.katniss.action.ACK_THIRD_PARTY_DISCLOSURE", jiTUpdateReceiverActivity.getIntent().getAction())) {
                ((zdv) ipw.a.b().q("com/google/android/apps/tvsearch/setup/receiver/JiTUpdateReceiverActivityPeer", "onCreate", 29, "JiTUpdateReceiverActivityPeer.kt")).u("Acknowledged third-party disclosure.");
                ipwVar.d.q(ipwVar.c.c());
            }
            jiTUpdateReceiverActivity.finish();
            this.o = false;
            wszVar.o();
            ((wsx) wwtVarV).a.t();
        } catch (Throwable th) {
    ...
    @Override // defpackage.ipu, defpackage.gf, defpackage.bw, android.app.Activity
