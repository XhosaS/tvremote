package com.google.android.apps.tvsearch.app.launch.permission;
...
public final class RequestPermissionsProxyActivity extends eyb implements wgt, wgr, wip {
    private eyd m;
    private boolean o;
    private Context p;
    private bco r;
    ...
    public RequestPermissionsProxyActivity() {
    ...
    public final void M() {
        if (this.m == null) {
            ...
            try {
                ...
                try {
                    try {
                        Activity activity = ((etb) cO().dN()).a;
                        aeiv.a(activity);
                        if (!(activity instanceof RequestPermissionsProxyActivity)) {
                            throw new IllegalStateException(a.w((tt) activity, eyd.class));
                        }
                        this.m = new eyd((RequestPermissionsProxyActivity) activity);
                        wvxVarF.close();
    ...
    @Override // defpackage.eyb, defpackage.bw, defpackage.tt, defpackage.eq, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            M();
            RequestPermissionsProxyActivity requestPermissionsProxyActivity = this.m.b;
            String[] stringArrayExtra = requestPermissionsProxyActivity.getIntent().getStringArrayExtra("com.google.android.katniss.search.extra.REQUEST_PERMISSIONS_NAMES");
            if (stringArrayExtra == null || stringArrayExtra.length == 0) {
                ((zdv) eyd.a.c().q("com/google/android/apps/tvsearch/app/launch/permission/RequestPermissionsProxyActivityPeer", "onCreate", 28, "RequestPermissionsProxyActivityPeer.kt")).u("Permissions for request are missing");
                requestPermissionsProxyActivity.finish();
            } else {
                Arrays.toString(stringArrayExtra).getClass();
                requestPermissionsProxyActivity.requestPermissions(stringArrayExtra, 1);
                View view = new View(requestPermissionsProxyActivity);
                view.setBackgroundColor(0);
                requestPermissionsProxyActivity.setContentView(view, new ViewGroup.LayoutParams(-1, -1));
            }
            this.o = false;
            wszVar.o();
            ((wsx) wwtVarV).a.t();
    ...
    @Override // defpackage.eyb, defpackage.gf, defpackage.bw, android.app.Activity
    ...
    public final void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        ...
        try {
            ...
            if (i == 1) {
                ...
                if (length == length2) {
                    Iterable agqoVar = length2 == 0 ? agrd.a : new agqo(iArr);
                    ArrayList arrayList = new ArrayList(Math.min(agqq.i(agqoVar, 10), length));
                    int i2 = 0;
                    for (Object obj : agqoVar) {
                        if (i2 >= length) {
                            break;
                        }
                        int i3 = i2 + 1;
                    ...
                    ((zdv) eyd.a.d().q("com/google/android/apps/tvsearch/app/launch/permission/RequestPermissionsProxyActivityPeer", "onRequestPermissionsResult", 69, "RequestPermissionsProxyActivityPeer.kt")).z("Unequal size of permission requests(=%d) and grants(=%d)", length, length2);
                }
            }
            eydVar.b.finish();
            wwtVarN.close();
