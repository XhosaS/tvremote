package com.google.android.apps.tvsearch.preferences.udcdisplay;
...
public final class UdcDisplayActivity extends hbm implements wgt, wgr, wip {
    private hbp m;
    private boolean o;
    private Context p;
    private bco r;
    ...
    public UdcDisplayActivity() {
        this.f.a(new hbn(this));
    }
            ...
            try {
                ...
                try {
                    try {
                        ...
                        aeiv.a(activity);
                        if (!(activity instanceof UdcDisplayActivity)) {
                            throw new IllegalStateException(a.w((tt) activity, hbp.class));
                        }
                        this.m = new hbp((UdcDisplayActivity) activity);
                        wvxVarF.close();
                        this.m.d = this;
    ...
    @Override // defpackage.hbm, defpackage.bw, defpackage.tt, defpackage.eq, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            M();
            hbp hbpVar = this.m;
            UdcDisplayActivity udcDisplayActivity = hbpVar.c;
            hbpVar.b = new WebView(udcDisplayActivity);
            udcDisplayActivity.setContentView(hbpVar.b);
            hbpVar.b.getSettings().setJavaScriptEnabled(true);
            hbpVar.b.setWebChromeClient(new WebChromeClient());
            hbpVar.b.setWebViewClient(new hbo(hbpVar));
            hbpVar.b.loadUrl("https://myaccount.google.com/activitycontrols_atv_gnots");
            this.o = false;
            wszVar.o();
            ((wsx) wwtVarV).a.t();
        } catch (Throwable th) {
    ...
    @Override // defpackage.hbm, defpackage.gf, defpackage.bw, android.app.Activity
