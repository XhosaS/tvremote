...
public final class HttpEngineProviderSingleton {
    ...
    private boolean shouldOverrideWithHttpEngine(Context context) {
        try {
            try {
                return getReflectionValueAsBool(kov.a(ExperimentalCronetEngine.class, "shouldOverrideWithHttpEngine", new ExperimentalCronetEngineHolder(), new kou(Context.class, context)));
            } catch (Throwable unused) {
                return getReflectionValueAsBool(kov.a(ExperimentalCronetEngine.class, "shouldOverrideWithHttpEngine", null, new kou(Context.class, context)));
            }
