    ...
    public class Builder {
        ...
        */
        ...
        private static ICronetEngineBuilder createBuilderDelegate(Context context) {
            new ahya("CronetEngine#createBuilderDelegate");
            try {
                ...
                ahyc ahycVar = (ahyc) arrayList.get(0);
                aiag aiagVarA = aiah.a(context, ahycVar.b);
                ...
                try {
                    ...
                    if (Log.isLoggable(TAG, 3)) {
                        Log.d(TAG, String.format("Using '%s' provider for creating CronetEngine.Builder.", ahycVar.a));
                    }
                    ICronetEngineBuilder iCronetEngineBuilder = ahycVar.a.createBuilder().mBuilderDelegate;
                    String implCronetVersion = getImplCronetVersion(iCronetEngineBuilder);
                    if (implCronetVersion != null) {
                        aiacVar.f = new aiaf(implCronetVersion);
                    }
                    aiacVar.a = iCronetEngineBuilder.getLogCronetInitializationRef();
                    aiacVar.d = true;
                    Trace.endSection();
                    return iCronetEngineBuilder;
                } finally {
                    aiacVar.b = (int) (SystemClock.uptimeMillis() - jUptimeMillis);
                    aiagVarA.b(aiacVar);
                }
            } catch (Throwable th) {
                try {
        ...
        static List getEnabledCronetProviders(Context context, List list) {
            ...
            Collections.sort(list, new ahyb());
            return list;
        }
        ...
        static /* synthetic */ void lambda$setConnectionMigrationOptions$2(ConnectionMigrationOptions connectionMigrationOptions, JSONObject jSONObject) throws JSONException {
            JSONObject jSONObjectA = ahye.a(jSONObject, "QUIC");
        ...
        static /* synthetic */ void lambda$setDnsOptions$1(DnsOptions dnsOptions, JSONObject jSONObject) throws JSONException {
            ...
            JSONObject jSONObjectA3 = ahye.a(jSONObject, "QUIC");
        ...
        private void maybeSetExperimentalOptions() {
            ...
            if (jSONObject2 == null && list.isEmpty()) {
                ...
                while (it.hasNext()) {
                    try {
                        ((ahyd) it.next()).applyTo(jSONObject2);
        ...
        public Builder setConnectionMigrationOptions(final ConnectionMigrationOptions connectionMigrationOptions) {
            ...
            this.mExperimentalOptionsPatches.add(new ahyd() { // from class: org.chromium.net.CronetEngine$Builder$$ExternalSyntheticLambda1
        ...
        public Builder setDnsOptions(final DnsOptions dnsOptions) {
            ...
            this.mExperimentalOptionsPatches.add(new ahyd() { // from class: org.chromium.net.CronetEngine$Builder$$ExternalSyntheticLambda2
                @Override // defpackage.ahyd
                public final void applyTo(JSONObject jSONObject) throws JSONException {
        ...
        public Builder setQuicOptions(final QuicOptions quicOptions) {
            ...
            this.mExperimentalOptionsPatches.add(new ahyd() { // from class: org.chromium.net.CronetEngine$Builder$$ExternalSyntheticLambda0
                @Override // defpackage.ahyd
                public final void applyTo(JSONObject jSONObject) throws JSONException {
