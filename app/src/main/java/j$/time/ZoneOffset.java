...
public final class ZoneOffset extends ZoneId implements j$.time.temporal.k, j$.time.temporal.l, Comparable<ZoneOffset>, Serializable {
    ...
    public static final ZoneOffset f = e0(-64800);
    public static final ZoneOffset g = e0(64800);
    ...
    public static ZoneOffset b0(Temporal temporal) {
        ...
        ZoneOffset zoneOffset = (ZoneOffset) temporal.U(j$.time.temporal.o.d);
        if (zoneOffset != null) {
            return zoneOffset;
        }
        throw new b(e.a("Unable to obtain ZoneOffset from TemporalAccessor: ", String.valueOf(temporal), " of type ", temporal.getClass().getName()));
    }
    ...
    */
    ...
    public static ZoneOffset d0(int i, int i2, int i3) {
        if (i < -18 || i > 18) {
        ...
        return e0((i2 * 60) + (i * 3600) + i3);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static ZoneOffset e0(int i) {
        if (i < -64800 || i > 64800) {
            throw new b("Zone offset not in valid range: -18:00 to +18:00");
        }
        if (i % 900 != 0) {
    ...
    public static int f0(String str, int i, boolean z) {
        if (z && str.charAt(i - 1) != ':') {
    ...
    public static ZoneOffset g0(ObjectInput objectInput) throws IOException {
        byte b = objectInput.readByte();
        return b == Byte.MAX_VALUE ? e0(objectInput.readInt()) : e0(b * 900);
    }
    ...
    public final j$.time.zone.e W() {
        return new j$.time.zone.e(this);
    }

    @Override // j$.time.ZoneId
    public final void a0(ObjectOutput objectOutput) throws IOException {
    ...
    public final int i(j$.time.temporal.n nVar) {
        ...
        return j$.time.temporal.o.d(this, nVar).a(H(nVar), nVar);
    }
