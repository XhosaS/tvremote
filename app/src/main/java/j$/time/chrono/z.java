...
public final class z implements n, Serializable {
    ...
    static {
        z zVar = new z(-1, j$.time.h.h0(1868, 1, 1), "Meiji");
        d = zVar;
        e = new z[]{zVar, new z(0, j$.time.h.h0(1912, 7, 30), "Taisho"), new z(1, j$.time.h.h0(1926, 12, 25), "Showa"), new z(2, j$.time.h.h0(1989, 1, 8), "Heisei"), new z(3, j$.time.h.h0(2019, 5, 1), "Reiwa")};
    }
    ...
    public static z c(j$.time.h hVar) {
        if (hVar.c0(y.d)) {
    ...
    public final j$.time.temporal.q m(j$.time.temporal.n nVar) {
        ...
        return nVar == aVar ? w.c.w(aVar) : j$.time.temporal.o.d(this, nVar);
    }
