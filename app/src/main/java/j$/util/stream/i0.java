...
public class i0 extends AbstractC0085c implements Consumer, Iterable, j$.lang.a {
    ...
    public Spliterator spliterator() {
        return new d0(this, 0, this.b, 0, this.a);
    }

    public final String toString() {
        ArrayList arrayList = new ArrayList();
        forEach(new j$.desugar.sun.nio.fs.h(7, arrayList));
