...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable, x {
    ...
    public static final boolean b(l[] lVarArr, int i2, l lVar) {
        return j$.com.android.tools.r8.a.a(h.a, lVarArr, (i2 << o) + n, null, lVar);
    }
