...
public final class d implements Serializable {
    ...
    public d(k kVar, int i, j$.time.c cVar, j jVar, boolean z, c cVar2, y yVar, y yVar2, y yVar3) {
        this.a = kVar;
        this.b = (byte) i;
        this.c = cVar;
        this.d = jVar;
    ...
    public static d a(ObjectInput objectInput) {
        ...
        int i3 = (3670016 & i) >>> 19;
        j$.time.c cVarD = i3 == 0 ? null : j$.time.c.D(i3);
        int i4 = (507904 & i) >>> 14;
        ...
        if (i4 == 31) {
            ...
            cVar = cVar2;
            long j2 = j - (i8 * 3600);
            jVarE = j.E(i8, (int) (j2 / 60), (int) (j2 - (r8 * 60)), 0);
        } else {
            cVar = cVar2;
            int i9 = i4 % 24;
            j jVar2 = j.e;
        ...
        y yVarJ = y.J(i5 == 255 ? objectInput.readInt() : (i5 - 128) * 900);
        int i10 = yVarJ.a;
        y yVarJ2 = y.J(i6 == 3 ? objectInput.readInt() : (i6 * 1800) + i10);
        y yVarJ3 = y.J(i7 == 3 ? objectInput.readInt() : (i7 * 1800) + i10);
        boolean z = i4 == 24;
        Objects.a(kVarG, "month");
        Objects.a(jVarE, "time");
        Objects.a(cVar, "timeDefnition");
        if (i2 < -28 || i2 > 31 || i2 == 0) {
            throw new IllegalArgumentException("Day of month indicator must be between -28 and 31 inclusive excluding zero");
        }
        if (z && !jVarE.equals(j.g)) {
            throw new IllegalArgumentException("Time must be midnight when end of day flag is true");
        }
        if (jVarE.d == 0) {
            return new d(kVarG, i2, cVarD, jVarE, z, cVar, yVarJ, yVarJ2, yVarJ3);
        }
    ...
    public final int hashCode() {
        ...
        return ((this.g.a ^ (this.f.ordinal() + (iP + ((cVar == null ? 7 : cVar.ordinal()) << 2)))) ^ this.h.a) ^ this.i.a;
    }
    ...
    public final String toString() {
        ...
        int i = yVar.a;
        y yVar2 = this.h;
        sb.append(i - yVar2.a > 0 ? "Gap " : "Overlap ");
        sb.append(yVar2);
        sb.append(" to ");
        sb.append(yVar);
        sb.append(", ");
    ...
    public final void writeExternal(ObjectOutput objectOutput) {
        ...
        j jVar = this.d;
        boolean z = this.e;
        int iP = z ? 86400 : jVar.P();
        int i3 = this.g.a;
        int i4 = i2 - i3;
        int i5 = i - i3;
        byte b = iP % 3600 == 0 ? z ? (byte) 24 : jVar.a : (byte) 31;
