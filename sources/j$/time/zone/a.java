...
public final class a implements Externalizable {
    ...
    public static y b(ObjectInput objectInput) throws IOException {
        byte b = objectInput.readByte();
        return b == Byte.MAX_VALUE ? y.J(objectInput.readInt()) : y.J(b * 900);
    }
    ...
    public static void d(y yVar, ObjectOutput objectOutput) throws IOException {
        int i = yVar.a;
    ...
    public final void readExternal(ObjectInput objectInput) throws IOException {
        ...
        if (b == 1) {
            ...
            eVar = new e(jArr2, yVarArr, jArr3, yVarArr2, dVarArr);
        } else if (b == 2) {
