...
public class ListMenuItemView extends LinearLayout implements AbsListView.SelectionBoundsAdjuster, eh {
    public dw a;
    public ImageView b;
    public boolean c;
    public boolean d;
    ...
    /* JADX WARN: Type inference failed for: r11v0, types: [android.support.v7.view.menu.ListMenuItemView, android.view.ViewGroup, eh] */
    ...
    public final void f(dw dwVar) {
        ...
        CharSequence charSequenceF = dwVar.f(this);
        ...
        if (i == 0) {
            ...
            if (cE == 0) {
                ...
                int i2 = duVar.x() ? dwVar2.i : dwVar2.g;
                dw.g(sb, i2, 65536, resources.getString(R.string.abc_menu_meta_shortcut_label));
                dw.g(sb, i2, 4096, resources.getString(R.string.abc_menu_ctrl_shortcut_label));
                dw.g(sb, i2, 2, resources.getString(R.string.abc_menu_alt_shortcut_label));
                dw.g(sb, i2, 1, resources.getString(R.string.abc_menu_shift_shortcut_label));
                dw.g(sb, i2, 4, resources.getString(R.string.abc_menu_sym_shortcut_label));
                dw.g(sb, i2, 8, resources.getString(R.string.abc_menu_function_shortcut_label));
                if (cE == '\b') {
        ...
        boolean zHasSubMenu = dwVar.hasSubMenu();
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        aps apsVarR = aps.r(getContext(), attributeSet, cu.r, i, 0);
        this.m = apsVarR.i(5);
        this.n = apsVarR.g(1, -1);
        this.c = apsVarR.n(7, false);
        this.o = context;
        this.p = apsVarR.i(8);
