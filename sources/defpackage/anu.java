...
public final class anu implements AutoCloseable, anv {
    ...
    public anu(Context context) throws RemoteException {
        ...
        if (providerInfoResolveContentProvider == null || !ii.X(providerInfoResolveContentProvider.applicationInfo.packageName, "com.google.android.gms")) {
    ...
    @Override // java.lang.AutoCloseable, defpackage.anv
