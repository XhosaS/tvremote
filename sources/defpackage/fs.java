...
class fs {
    ...
    public fs(ProgressBar progressBar) {
        this.c = progressBar;
    }
    ...
    public void b(AttributeSet attributeSet, int i) {
        ...
        aps apsVarR = aps.r(progressBar.getContext(), attributeSet, b, i, 0);
        ...
        Drawable drawableJ2 = apsVarR.j(1);
        if (drawableJ2 != null) {
            progressBar.setProgressDrawable(a(drawableJ2, false));
        }
        apsVarR.m();
    }
}
