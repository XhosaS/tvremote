...
public final class dmk implements PrivateKey, Key {
    private static final long serialVersionUID = 1;
    private transient dhd a;
    private transient dai b;

    public dmk(dcj dcjVar) {
        a(dcjVar);
    }

    private final void a(dcj dcjVar) {
        this.b = dcjVar.b;
        this.a = (dhd) dnx.u(dcjVar);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof dmk) {
            return Arrays.equals(this.a.a(), ((dmk) obj).a.a());
        }
        return false;
    }
