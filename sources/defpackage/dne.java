...
public final class dne implements PrivateKey, Key {
    private static final long serialVersionUID = 1;
    private transient diz a;
    private transient dai b;

    public dne(dcj dcjVar) {
        a(dcjVar);
    }

    private final void a(dcj dcjVar) {
        this.b = dcjVar.b;
        this.a = (diz) dnx.u(dcjVar);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof dne) {
            return Arrays.equals(this.a.a(), ((dne) obj).a.a());
        }
        return false;
    }
