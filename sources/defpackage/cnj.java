...
public final class cnj extends ckh implements RandomAccess {
    ...
    public final /* bridge */ /* synthetic */ cme d(int i) {
        if (i >= this.d) {
            return new cnj(i == 0 ? c : Arrays.copyOf(this.b, i), this.d, true);
        }
    ...
    private cnj(Object[] objArr, int i, boolean z) {
        super(z);
        this.b = objArr;
        this.d = i;
    }
