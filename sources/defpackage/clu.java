...
public final class clu extends ckh implements RandomAccess, cma, cnh {
    ...
    public final boolean addAll(Collection collection) {
        aS();
        cmf.d(collection);
        if (!(collection instanceof clu)) {
            return super.addAll(collection);
        }
        clu cluVar = (clu) collection;
        int i = cluVar.c;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(cluVar.b, 0, this.b, this.c, cluVar.c);
        this.c = i3;
        this.modCount++;
        return true;
    }
    ...
    public final cma d(int i) {
        if (i >= this.c) {
            return new clu(i == 0 ? d : Arrays.copyOf(this.b, i), this.c, true);
        }
    ...
    private clu(int[] iArr, int i, boolean z) {
        super(z);
        this.b = iArr;
        this.c = i;
    }
