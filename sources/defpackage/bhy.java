...
public final class bhy extends tu {
    final /* synthetic */ BottomSheetBehavior a;

    public bhy(BottomSheetBehavior bottomSheetBehavior) {
    ...
    */
    public final void d(android.view.View r6, float r7, float r8) throws android.content.res.Resources.NotFoundException {
        ...
        Ld8:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bhy.d(android.view.View, float, float):void");
    }
    ...
    public final int g(View view, int i) {
        return mo.E(i, this.a.a(), h());
    }

    @Override // defpackage.tu
    public final int h() {
        BottomSheetBehavior bottomSheetBehavior = this.a;
        return bottomSheetBehavior.ac() ? bottomSheetBehavior.z : bottomSheetBehavior.r;
    }
