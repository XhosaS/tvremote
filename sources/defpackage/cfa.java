...
public enum cfa {
    ...
    static {
        ...
        for (cfa cfaVar : values()) {
            if (map.put(Character.valueOf(cfaVar.G), cfaVar) != null) {
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(String.valueOf(cfaVar))));
            }
        }
