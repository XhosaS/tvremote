...
final class ug implements TextWatcher, SpanWatcher {
    final Object a;
    ...
    public final void onSpanAdded(Spannable spannable, Object obj, int i, int i2) {
        if (this.b.get() <= 0 || !(obj instanceof uf)) {
    ...
    */
    public final void onSpanChanged(android.text.Spannable r9, java.lang.Object r10, int r11, int r12, int r13, int r14) {
        /*
            ...
            int r0 = r0.get()
            if (r0 <= 0) goto Le
            boolean r0 = r10 instanceof defpackage.uf
            if (r0 != 0) goto Ld
            goto Le
        Ld:
            return
        ...
        L1f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ug.onSpanChanged(android.text.Spannable, java.lang.Object, int, int, int, int):void");
    }
