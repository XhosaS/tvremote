...
public final class blf extends gm {
    public blf(Context context, AttributeSet attributeSet) throws Resources.NotFoundException {
        super(blh.a(context, attributeSet, R.attr.textViewStyle, 0), attributeSet, R.attr.textViewStyle);
    ...
    private final void b(Resources.Theme theme, int i) throws Resources.NotFoundException {
        TypedArray typedArrayObtainStyledAttributes = theme.obtainStyledAttributes(i, blg.a);
    ...
    private static boolean c(Context context) {
        return xo.i(context, com.google.android.tv.remote.service.R.attr.textAppearanceLineHeightEnabled, true);
    }

    @Override // defpackage.gm, android.widget.TextView
