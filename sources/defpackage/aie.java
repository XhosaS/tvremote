...
public final class aie {
    ...
    public static String b(Context context, int i) {
        ...
        if (i == 2) {
            return ajq.e(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, strA);
        }
        if (i == 3) {
    ...
    public static String c(Context context, int i) {
        ...
        switch (i) {
            ...
            case 19:
            default:
                Log.e("GoogleApiAvailability", b.e(i, "Unexpected error code "));
                return null;
            case 16:
    ...
    public static String e(Context context, String str) {
        ...
        mi miVar = a;
        synchronized (miVar) {
            Locale localeF = oi.d(context.getResources().getConfiguration().getLocales()).f(0);
            if (!localeF.equals(b)) {
                miVar.clear();
                b = localeF;
            }
            String str2 = (String) miVar.get(str);
            if (str2 != null) {
                return str2;
            }
            boolean z = afp.a;
            ...
            if (identifier == 0) {
                Log.w("GoogleApiAvailability", b.g(str, "Missing resource: "));
                return null;
            }
            String string = resourcesForApplication.getString(identifier);
            if (TextUtils.isEmpty(string)) {
                Log.w("GoogleApiAvailability", b.g(str, "Got empty resource: "));
                return null;
            }
            a.put(str, string);
            return string;
