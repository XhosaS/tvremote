...
public final class dw implements og {
    private View B;
    ...
    public dw(du duVar, int i, int i2, int i3, int i4, CharSequence charSequence, int i5) {
        this.j = duVar;
        this.a = i2;
        this.b = i;
        this.q = i3;
    ...
    @Override // defpackage.og, android.view.MenuItem
    ...
    public final CharSequence f(eh ehVar) {
        return ehVar.e() ? getTitleCondensed() : this.d;
    }
    ...
    public final Drawable getIcon() {
        ...
        Drawable drawableJ = ii.J(this.j.a, i);
        this.t = 0;
        this.s = drawableJ;
        return v(drawableJ);
    }
    ...
    public final boolean isVisible() {
        qk qkVar = this.p;
        return (qkVar == null || !qkVar.f()) ? (this.A & 8) == 0 : (this.A & 8) == 0 && this.p.d();
    }
    ...
    public final void l(en enVar) {
        this.k = enVar;
        enVar.setHeaderTitle(this.d);
    }

    public final boolean m() {
        qk qkVar;
        if ((this.n & 8) != 0) {
            if (this.B == null && (qkVar = this.p) != null) {
                this.B = qkVar.a(this);
            }
            if (this.B != null) {
                return true;
    ...
    public final boolean n() {
        ...
        du duVar = this.j;
        if (duVar.u(duVar, this)) {
            return true;
        }
        Intent intent = this.e;
        if (intent != null) {
            try {
                duVar.a.startActivity(intent);
                return true;
    ...
    public final MenuItem setChecked(boolean z) {
        ...
        du duVar = this.j;
        int i = this.b;
        ArrayList arrayList = duVar.c;
        int size = arrayList.size();
        duVar.s();
        for (int i2 = 0; i2 < size; i2++) {
            dw dwVar = (dw) arrayList.get(i2);
            if (dwVar.b == i && dwVar.p() && dwVar.isCheckable()) {
                dwVar.i(dwVar == this);
            }
        }
        duVar.r();
    ...
    public final MenuItem setTitle(CharSequence charSequence) {
        ...
        en enVar = this.k;
        if (enVar != null) {
            enVar.setHeaderTitle(charSequence);
        }
        return this;
    }
