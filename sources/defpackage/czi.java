...
public class czi extends dab {
    ...
    private static final String o(int i) {
        return i < 10 ? b.e(i, "0") : Integer.toString(i);
    }
    ...
    @Override // defpackage.dab
    public void c(czz czzVar, boolean z) throws IOException {
        czzVar.j(z, 24, this.a);
    }

    @Override // defpackage.dab
    public final boolean d(dab dabVar) {
        if (dabVar instanceof czi) {
            return Arrays.equals(this.a, ((czi) dabVar).a);
        }
        return false;
    }
    ...
    public final Date f() {
        ...
        String strA = doj.a(this.a);
        if (strA.endsWith("Z")) {
            simpleDateFormatM = g() ? new SimpleDateFormat("yyyyMMddHHmmss.SSS'Z'", dcc.a) : i() ? new SimpleDateFormat("yyyyMMddHHmmss'Z'", dcc.a) : h() ? new SimpleDateFormat("yyyyMMddHHmm'Z'", dcc.a) : new SimpleDateFormat("yyyyMMddHH'Z'", dcc.a);
    ...
    @Override // defpackage.dab
    public dab k() {
        return new dbf(this.a);
    }

    public czi(byte[] bArr) {
        if (bArr.length >= 4) {
            this.a = bArr;
            if (!n(0) || !n(1) || !n(2) || !n(3)) {
