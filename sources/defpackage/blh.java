...
public final class blh {
    private static final int[] a = {R.attr.theme, com.google.android.tv.remote.service.R.attr.theme};
    private static final int[] b = {com.google.android.tv.remote.service.R.attr.materialThemeOverlay};
    ...
    public static Context b(Context context, AttributeSet attributeSet, int i, int i2, int[] iArr) {
        ...
        boolean z = (context instanceof lh) && ((lh) context).a == i3;
        if (i3 == 0 || z) {
            return context;
        }
        lh lhVar = new lh(context, i3);
        int[] iArrC = c(context, attributeSet, iArr, i, i2);
        int length = iArrC.length;
        for (int i4 = 0; i4 < length; i4 = 1) {
            int i5 = iArrC[0];
            if (i5 != 0) {
                lhVar.getTheme().applyStyle(i5, true);
            }
        }
        ...
        if (resourceId != 0) {
            lhVar.getTheme().applyStyle(resourceId, true);
        }
        return lhVar;
    }
