...
public final class dml implements PublicKey, Key {
    private static final long serialVersionUID = 1;
    private transient dhe a;

    public dml(ddp ddpVar) {
        a(ddpVar);
    }

    private final void a(ddp ddpVar) {
        this.a = (dhe) dld.a(ddpVar);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof dml) {
            return Arrays.equals(this.a.a(), ((dml) obj).a.a());
        }
        return false;
    }
