...
public class del implements deh {
        ...
        if (!this.f) {
            ...
            if (i4 == this.c) {
                ...
                for (int i8 = 0; i8 < i5; i8++) {
                    long[] jArr = this.a;
                    jArr[i8] = jArr[i8] ^ dos.e(bArr2, i7);
                    i7 += 8;
                }
                if (i6 > 0) {
                    long j2 = 1 << i6;
                    long[] jArr2 = this.a;
                    jArr2[i5] = (dos.e(bArr2, i7) & (j2 - 1)) ^ jArr2[i5];
                }
            }
            long[] jArr3 = this.a;
            int i9 = (this.c - 1) >>> 6;
