...
public final class hi extends ii implements ip {
    ...
    public hi(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i, int i2, int i3) {
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        this.p = valueAnimatorOfFloat;
        this.q = 0;
        this.D = new ac(this, 9, null);
        ...
        valueAnimatorOfFloat.addListener(new hh(this));
        valueAnimatorOfFloat.addUpdateListener(new rb(this, 1));
        RecyclerView recyclerView2 = this.l;
        if (recyclerView2 == recyclerView) {
            return;
        }
        if (recyclerView2 != null) {
            in inVar = recyclerView2.m;
            if (inVar != null) {
                inVar.N("Cannot remove item decoration during a scroll  or layout");
            }
        ...
        if (recyclerView != null) {
            in inVar2 = recyclerView.m;
            if (inVar2 != null) {
                inVar2.N("Cannot add item decoration during a scroll  or layout");
            }
    ...
    private static final int aj(float f, float f2, int[] iArr, int i, int i2, int i3) {
        ...
        if (motionEvent.getAction() == 2 && this.o == 2) {
            ...
            if (this.A == 1) {
                ...
                if (Math.abs(this.h - fMax) >= 2.0f) {
                    int iAj = aj(this.i, fMax, iArr, this.l.computeHorizontalScrollRange(), this.l.computeHorizontalScrollOffset(), this.j);
                    if (iAj != 0) {
                        this.l.scrollBy(iAj, 0);
                    }
                    this.i = fMax;
                }
            }
            if (this.A == 2) {
                ...
                if (Math.abs(this.e - fMax2) >= 2.0f) {
                    int iAj2 = aj(this.f, fMax2, iArr2, this.l.computeVerticalScrollRange(), this.l.computeVerticalScrollOffset(), this.k);
                    if (iAj2 != 0) {
                        this.l.scrollBy(0, iAj2);
                    }
                    this.f = fMax2;
                }
            }
