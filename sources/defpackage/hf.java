...
public class hf extends ListView {
    public boolean a;
    public ac b;
    ...
    */
    public final boolean a(android.view.MotionEvent r18, int r19) throws java.lang.IllegalAccessException, java.lang.IllegalArgumentException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.hf.a(android.view.MotionEvent, int):boolean");
    }
    ...
    public boolean onHoverEvent(MotionEvent motionEvent) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (actionMasked == 10) {
            if (this.b == null) {
                ac acVar = new ac(this, 8, null);
                this.b = acVar;
                ((hf) acVar.a).post(acVar);
            }
            actionMasked = 10;
        }
        ...
        if (iPointToPosition != -1 && iPointToPosition != getSelectedItemPosition()) {
            ...
            if (childAt.isEnabled()) {
                requestFocus();
                if (Build.VERSION.SDK_INT < 30 || !hc.d) {
                    ...
                    try {
                        ...
                        hc.b.invoke(this, numValueOf);
                        hc.c.invoke(this, numValueOf);
    ...
    public final void setSelector(Drawable drawable) {
        hd hdVar = drawable != null ? new hd(drawable) : null;
        this.i = hdVar;
        super.setSelector(hdVar);
        Rect rect = new Rect();
        if (drawable != null) {
