...
public final class jk {
    ...
    public jk(StaggeredGridLayoutManager staggeredGridLayoutManager, int i) {
        this.f = staggeredGridLayoutManager;
        this.e = i;
    }

    public static final jh n(View view) {
        return (jh) view.getLayoutParams();
    }
    ...
    public final View g(int i, int i2) {
        ...
        if (i2 != -1) {
            ...
            while (size >= 0) {
                ...
                if ((staggeredGridLayoutManager.d && StaggeredGridLayoutManager.bp(view2) >= i) || ((!staggeredGridLayoutManager.d && StaggeredGridLayoutManager.bp(view2) <= i) || !view2.hasFocusable())) {
                    break;
                }
                size--;
                view = view2;
        ...
        while (i3 < size2) {
            ...
            if ((staggeredGridLayoutManager2.d && StaggeredGridLayoutManager.bp(view3) <= i) || ((!staggeredGridLayoutManager2.d && StaggeredGridLayoutManager.bp(view3) >= i) || !view3.hasFocusable())) {
                break;
            }
            i3++;
            view = view3;
