...
public final class dng implements PrivateKey, Key {
    private static final long serialVersionUID = 1;
    private transient djl a;
    private transient dai b;

    public dng(dcj dcjVar) {
        a(dcjVar);
    }

    private final void a(dcj dcjVar) {
        this.b = dcjVar.b;
        this.a = (djl) dnx.u(dcjVar);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof dng) {
            return Arrays.equals(this.a.a(), ((dng) obj).a.a());
        }
        return false;
    }
