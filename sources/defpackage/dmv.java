...
public final class dmv implements PrivateKey, Key {
    private static final long serialVersionUID = 1;
    private transient dih a;
    private transient dai b;

    public dmv(dcj dcjVar) {
        a(dcjVar);
    }

    private final void a(dcj dcjVar) {
        this.b = dcjVar.b;
        this.a = (dih) dnx.u(dcjVar);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof dmv) {
            return Arrays.equals(this.a.a(), ((dmv) obj).a.a());
        }
        return false;
    }
