...
public final class cfi extends RuntimeException {
    ...
    public static cfi a(String str, String str2, int i) {
        return new cfi(d(str, str2, i, i + 1));
    }

    public static cfi b(String str, String str2, int i, int i2) {
        return new cfi(d(str, str2, i, i2));
    }

    public static cfi c(String str, String str2, int i) {
        return new cfi(d(str, str2, i, -1));
    }
