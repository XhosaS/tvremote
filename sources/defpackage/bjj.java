...
public final class bjj {
    ...
    public static void a(Context context, AttributeSet attributeSet, int i, int i2) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, bji.b, i, i2);
    ...
    private static void d(Context context, int[] iArr, String str) {
        ...
        for (int i = 0; i <= 0; i++) {
            if (!typedArrayObtainStyledAttributes.hasValue(i)) {
                typedArrayObtainStyledAttributes.recycle();
                throw new IllegalArgumentException(b.c(str, "The style on this component requires your app theme to be ", " (or a descendant)."));
            }
        }
        typedArrayObtainStyledAttributes.recycle();
    }
