...
class nw extends od {
    ...
    public Typeface a(Context context, ou[] ouVarArr, int i) throws IOException {
        Typeface typefaceL;
    ...
    @Override // defpackage.od
    public Typeface b(Context context, asv asvVar, Resources resources, int i) throws NoSuchMethodException, ClassNotFoundException, SecurityException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        Object obj = asvVar.a;
        Object objG = g();
        for (nl nlVar : (nl[]) obj) {
            ...
            if (fileF != null) {
                try {
                    if (mo.I(fileF, resources, nlVar.f)) {
