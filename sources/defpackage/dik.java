...
public final class dik extends dio {
    ...
    private dik(int i, List list, List list2, long j, long j2, boolean z) {
        super(true);
        this.h = 0L;
        this.b = i;
    ...
    public static dik a(Object obj) {
        Throwable th;
        ...
        for (int i2 = 0; i2 < i; i2++) {
            arrayList.add(diq.a(obj));
        }
        for (int i3 = 0; i3 < i - 1; i3++) {
            arrayList2.add(dis.a(obj));
        }
        return new dik(i, arrayList, arrayList2, j, j2, z);
    }

    public final synchronized dil b() {
        return new dil(this.b, ((diq) this.e.get(0)).b());
    }
    ...
    public final boolean equals(Object obj) {
        ...
        dik dikVar = (dik) obj;
        if (this.b == dikVar.b && this.d == dikVar.d && this.g == dikVar.g && this.h == dikVar.h && this.e.equals(dikVar.e)) {
            return this.f.equals(dikVar.f);
        }
        return false;
    }
    ...
    public final synchronized byte[] s() {
        ...
        dnx.R(this.h, byteArrayOutputStream);
        dnx.R(this.g, byteArrayOutputStream);
        byteArrayOutputStream.write(this.d ? 1 : 0);
        Iterator it = this.e.iterator();
        while (it.hasNext()) {
            dnx.N((diq) it.next(), byteArrayOutputStream);
        }
        Iterator it2 = this.f.iterator();
        while (it2.hasNext()) {
            dnx.N((dis) it2.next(), byteArrayOutputStream);
        }
