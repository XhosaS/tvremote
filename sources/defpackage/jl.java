...
public final class jl {
    ...
    public static int a(Context context, int i) {
        ...
        return ns.d(b(context, i), Math.round(Color.alpha(r4) * f2));
    }

    public static int b(Context context, int i) {
        int[] iArr = g;
        iArr[0] = i;
        aps apsVarQ = aps.q(context, null, iArr);
        try {
            return ((TypedArray) apsVarQ.a).getColor(0, 0);
        } finally {
            apsVarQ.m();
        }
    }
    ...
    public static void d(View view, Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(cu.j);
        try {
