...
public class SearchBar extends RelativeLayout {
    ...
    private final void d() throws Resources.NotFoundException {
        ...
        if (!TextUtils.isEmpty(null)) {
            string = e() ? getResources().getString(R.string.lb_search_bar_hint_with_title_speech, null) : getResources().getString(R.string.lb_search_bar_hint_with_title, null);
        } else if (e()) {
    ...
    protected final void onFinishInflate() throws Resources.NotFoundException {
        ...
        this.a.setOnFocusChangeListener(new wh(this, 1));
        this.a.addTextChangedListener(new wf(this, new ki(this, 8, null)));
        SearchEditText searchEditText = this.a;
        searchEditText.a = new qo();
        searchEditText.setOnEditorActionListener(new wg(this));
        this.a.setPrivateImeOptions("escapeNorth,voiceDismiss");
        SpeechOrbView speechOrbView = (SpeechOrbView) findViewById(R.id.lb_search_bar_speech_orb);
        this.b = speechOrbView;
        speechOrbView.a = new er(this, 3);
        speechOrbView.setOnFocusChangeListener(new wh(this, 0));
        c(hasFocus());
        d();
    }
