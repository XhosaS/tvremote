...
public class NestedScrollView extends FrameLayout implements pu {
    private static final float g = (float) (Math.log(0.78d) / Math.log(0.9d));
    private static final tl h = new tl();
    ...
    */
    ...
    private final boolean K(EdgeEffect edgeEffect, int i2) {
        ...
        float fC = qs.c(edgeEffect) * getHeight();
    ...
    private final boolean L(MotionEvent motionEvent) {
        boolean z;
        if (qs.c(this.b) != 0.0f) {
            qs.d(this.b, 0.0f, motionEvent.getX() / getWidth());
            z = true;
        } else {
            z = false;
        }
        ...
        qs.d(this.c, 0.0f, 1.0f - (motionEvent.getX() / getWidth()));
        return true;
    }
    ...
    private final asv O() {
        if (this.f == null) {
            this.f = new asv((View) this, (byte[]) null);
        }
        return this.f;
    }
    ...
    */
    ...
    final int i(int i2, int i3, MotionEvent motionEvent, int i4, int i5, boolean z) {
        ...
        if (motionEvent == null || scrollY2 == 0) {
            ...
            i8 = 0;
            z2 = 1;
            O().U(motionEvent.getDeviceId(), motionEvent.getSource(), i3, scrollY2);
        }
        iArr[z2] = i8;
        ...
        if (i11 < 0) {
            if (z3) {
                qs.d(this.b, (-i10) / getHeight(), i4 / getWidth());
                if (motionEvent != null) {
                    O().T(motionEvent.getDeviceId(), motionEvent.getSource(), i3, z2);
                }
                if (!this.c.isFinished()) {
                    this.c.onRelease();
                }
            ...
            qs.d(this.c, i10 / getHeight(), 1.0f - (i4 / getWidth()));
            if (motionEvent != null) {
                O().T(motionEvent.getDeviceId(), motionEvent.getSource(), i3, i8);
            }
            if (!this.b.isFinished()) {
                this.b.onRelease();
            }
    ...
    public final void j(int i2) {
        if (getChildCount() > 0) {
            ...
            if (Build.VERSION.SDK_INT >= 35) {
                sd.b(this, Math.abs(this.a.getCurrVelocity()));
            }
        }
    }
    ...
    public final boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.q) {
            if (qk.k(motionEvent, 2)) {
                axisValue = motionEvent.getAxisValue(9);
                i2 = 9;
                width = (int) motionEvent.getX();
            } else if (qk.k(motionEvent, 4194304)) {
            ...
            if (axisValue != 0.0f) {
                i(-((int) (axisValue * a())), i2, motionEvent, width, 1, qk.k(motionEvent, 8194));
    ...
    */
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, com.google.android.tv.remote.service.R.attr.nestedScrollViewStyle);
    }
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.d = tmVar;
        this.e = new pm(getContext(), tmVar);
        this.b = qs.e(context, attributeSet);
        this.c = qs.e(context, attributeSet);
