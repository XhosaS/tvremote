...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    protected void onSeekTargetStep(int i, int i2, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        ...
        int iClampApplyScroll = clampApplyScroll(this.mInterimTargetDx, i);
        this.mInterimTargetDx = iClampApplyScroll;
        int iClampApplyScroll2 = clampApplyScroll(this.mInterimTargetDy, i2);
        this.mInterimTargetDy = iClampApplyScroll2;
        if (iClampApplyScroll == 0 && iClampApplyScroll2 == 0) {
    ...
    protected void updateActionForInterimTarget(RecyclerView.SmoothScroller.Action action) {
        ...
        action.update((int) (this.mInterimTargetDx * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (this.mInterimTargetDy * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (iCalculateTimeForScrolling * TARGET_SEEK_EXTRA_SCROLL_RATIO), this.mLinearInterpolator);
    }
