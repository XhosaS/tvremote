...
public class ThemeUtils {
    ...
    public static void checkAppCompatTheme(View view, Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(android.support.v7.appcompat.R.styleable.AppCompatTheme);
        try {
    ...
    static int getThemeAttrColor(Context context, int i, float f) {
        return csq.g(getThemeAttrColor(context, i), Math.round(Color.alpha(r0) * f));
    }
}
