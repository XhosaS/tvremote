...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void updateLayoutState(int i, int i2, boolean z, RecyclerView.State state) {
        ...
        if (i == 1) {
            ...
            LayoutState layoutState2 = this.mLayoutState;
            layoutState2.mItemDirection = true == this.mShouldReverseLayout ? -1 : 1;
            ...
            layoutState4.mItemDirection = true != this.mShouldReverseLayout ? -1 : 1;
    ...
    public PointF computeScrollVectorForPosition(int i) {
        ...
        float f = z != this.mShouldReverseLayout ? -1 : 1;
    ...
    public View findOnePartiallyOrCompletelyInvisibleChild(int i, int i2) {
        ...
        int startAfterPadding = this.mOrientationHelper.getStartAfterPadding();
        int i3 = decoratedStart < startAfterPadding ? 16388 : 4097;
        int i4 = decoratedStart < startAfterPadding ? 16644 : 4161;
    ...
    public View findOneVisibleChild(int i, int i2, boolean z, boolean z2) {
        ...
        return i3 == 0 ? this.mHorizontalBoundCheck.findOneViewWithinBoundFlags(i, i2, i4, i5) : this.mVerticalBoundCheck.findOneViewWithinBoundFlags(i, i2, i4, i5);
    }
    ...
    */
    public android.view.View findReferenceChild(android.support.v7.widget.RecyclerView.Recycler r17, android.support.v7.widget.RecyclerView.State r18, boolean r19, boolean r20) {
        /*
            r16 = this;
            r0 = r16
        ...
        L2b:
            ...
            android.support.v7.widget.OrientationHelper r14 = r0.mOrientationHelper
            int r14 = r14.getDecoratedStart(r12)
            android.support.v7.widget.OrientationHelper r15 = r0.mOrientationHelper
            int r15 = r15.getDecoratedEnd(r12)
            if (r13 < 0) goto L78
            if (r13 >= r6) goto L78
            android.view.ViewGroup$LayoutParams r13 = r12.getLayoutParams()
            android.support.v7.widget.RecyclerView$LayoutParams r13 = (android.support.v7.widget.RecyclerView.LayoutParams) r13
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (getChildCount() > 0) {
            if (this.mShouldReverseLayout ^ this.mStackFromEnd) {
                ...
                iFixLayoutEndGap = fixLayoutStartGap(i3, recycler, state, DEBUG);
            } else {
                int iFixLayoutStartGap = fixLayoutStartGap(i2, recycler, state, true);
                i3 = i2 + iFixLayoutStartGap;
                i4 = i + iFixLayoutStartGap;
                iFixLayoutEndGap = fixLayoutEndGap(i4, recycler, state, DEBUG);
            }
    ...
    public int scrollBy(int i, RecyclerView.Recycler recycler, RecyclerView.State state) {
        if (getChildCount() != 0 && i != 0) {
            ...
            LayoutState layoutState = this.mLayoutState;
            int iFill = layoutState.mScrollingOffset + fill(recycler, layoutState, state, DEBUG);
            if (iFill >= 0) {
                if (iAbs > iFill) {
                    i = i2 * iFill;
                }
    ...
    public void setOrientation(int i) {
        if (i != 0 && i != 1) {
            throw new IllegalArgumentException(a.cf(i, "invalid orientation:"));
        }
