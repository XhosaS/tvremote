...
public class ActionBarContextView extends AbsActionBarView {
    ...
    private void initTitle() {
        ...
        this.mSubtitleView.setVisibility(true != zIsEmpty2 ? 0 : 8);
    ...
    private void updatePadding() {
        super.setPadding(this.mInsetsPaddingLeft + this.mNonInsetsPaddingLeft, this.mInsetsPaddingTop + this.mNonInsetsPaddingTop, this.mInsetsPaddingRight + this.mNonInsetsPaddingRight, this.mInsetsPaddingBottom + this.mNonInsetsPaddingBottom);
    }
    ...
    public void initForMode(final ActionMode actionMode) {
        ...
        viewFindViewById.setOnClickListener(new View.OnClickListener() { // from class: android.support.v7.widget.ActionBarContextView.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                actionMode.finish();
            }
        });
        fb fbVar = (fb) actionMode.getMenu();
        ActionMenuPresenter actionMenuPresenter = this.mActionMenuPresenter;
        if (actionMenuPresenter != null) {
        ...
        fbVar.h(this.mActionMenuPresenter, this.mPopupContext);
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, android.support.v7.appcompat.R.styleable.ActionMode, R.attr.actionModeStyle, 0);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int size2 = i3 > 0 ? i3 + this.mInsetsPaddingTop + this.mInsetsPaddingBottom : View.MeasureSpec.getSize(i2);
        ...
        if (linearLayout != null && this.mCustomView == null) {
            if (this.mTitleOptional) {
                ...
                this.mTitleLayout.setVisibility(true != z ? 8 : 0);
            } else {
    ...
    public void setPadding(int i, int i2, int i3, int i4) {
        this.mNonInsetsPaddingLeft = i;
        this.mNonInsetsPaddingTop = i2;
        this.mNonInsetsPaddingRight = i3;
        this.mNonInsetsPaddingBottom = i4;
        updatePadding();
    }

    public void setPaddingForInsets(int i, int i2, int i3, int i4) {
        this.mInsetsPaddingLeft = i;
        this.mInsetsPaddingTop = i2;
        this.mInsetsPaddingRight = i3;
        this.mInsetsPaddingBottom = i4;
        updatePadding();
    }
    ...
    @Override // android.support.v7.widget.AbsActionBarView
    public /* bridge */ /* synthetic */ cxe setupAnimatorToVisibility(int i, long j) {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, android.support.v7.appcompat.R.styleable.ActionMode, i, 0);
        setBackground(tintTypedArrayObtainStyledAttributes.getDrawable(android.support.v7.appcompat.R.styleable.ActionMode_background));
        this.mTitleStyleRes = tintTypedArrayObtainStyledAttributes.getResourceId(5, 0);
        this.mSubtitleStyleRes = tintTypedArrayObtainStyledAttributes.getResourceId(4, 0);
        this.mContentHeight = tintTypedArrayObtainStyledAttributes.getLayoutDimension(3, 0);
        this.mCloseItemLayout = tintTypedArrayObtainStyledAttributes.getResourceId(2, R.layout.abc_action_mode_close_item_material);
        tintTypedArrayObtainStyledAttributes.recycle();
        this.mNonInsetsPaddingLeft = getPaddingLeft();
        this.mNonInsetsPaddingTop = getPaddingTop();
        this.mNonInsetsPaddingRight = getPaddingRight();
        this.mNonInsetsPaddingBottom = getPaddingBottom();
    }
}
