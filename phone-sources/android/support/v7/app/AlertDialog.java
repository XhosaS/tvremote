...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public class Builder {
        ...
        public Builder setItems(int i, DialogInterface.OnClickListener onClickListener) throws Resources.NotFoundException {
            CharSequence[] textArray = this.P.mContext.getResources().getTextArray(i);
            AlertController.AlertParams alertParams = this.P;
        ...
        public Builder setMultiChoiceItems(int i, boolean[] zArr, DialogInterface.OnMultiChoiceClickListener onMultiChoiceClickListener) throws Resources.NotFoundException {
            CharSequence[] textArray = this.P.mContext.getResources().getTextArray(i);
            AlertController.AlertParams alertParams = this.P;
            alertParams.mItems = textArray;
        ...
        public Builder setNegativeButton(int i, DialogInterface.OnClickListener onClickListener) {
            CharSequence text = this.P.mContext.getText(i);
            AlertController.AlertParams alertParams = this.P;
        ...
        public Builder setSingleChoiceItems(int i, int i2, DialogInterface.OnClickListener onClickListener) throws Resources.NotFoundException {
            CharSequence[] textArray = this.P.mContext.getResources().getTextArray(i);
            AlertController.AlertParams alertParams = this.P;
            alertParams.mItems = textArray;
            alertParams.mOnClickListener = onClickListener;
