...
public final class C0100h implements java.util.Map, Serializable, Map {
    private static final long serialVersionUID = 1978198479659022715L;
    public final java.util.Map a;
    public final C0100h b;
    public transient C0102j c;
    public transient C0102j d;
    public transient C0098f e;

    public C0100h(java.util.Map map) {
        map.getClass();
        this.a = map;
        this.b = this;
    }
    ...
    public final java.util.Set entrySet() {
        ...
        synchronized (this.b) {
            try {
                if (this.d == null) {
                    this.d = new C0102j(this.a.entrySet(), this.b);
                }
                c0102j = this.d;
            } catch (Throwable th) {
                throw th;
    ...
    public final java.util.Set keySet() {
        ...
        synchronized (this.b) {
            try {
                if (this.c == null) {
                    this.c = new C0102j(this.a.keySet(), this.b);
                }
                c0102j = this.c;
            } catch (Throwable th) {
                throw th;
    ...
    public final java.util.Collection values() {
        ...
        synchronized (this.b) {
            try {
                if (this.e == null) {
                    this.e = new C0098f(this.a.values(), this.b);
                }
                c0098f = this.e;
            } catch (Throwable th) {
                throw th;
