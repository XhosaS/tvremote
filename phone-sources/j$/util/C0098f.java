...
public class C0098f implements java.util.Collection, Serializable, Collection {
    private static final long serialVersionUID = 3053995032091335093L;
    public final java.util.Collection a;
    public final Serializable b;

    public C0098f(java.util.Collection collection) {
        collection.getClass();
        this.a = collection;
        this.b = this;
    }
    ...
    public C0098f(java.util.Collection collection, Serializable serializable) {
        collection.getClass();
        this.a = collection;
        this.b = serializable;
    }
