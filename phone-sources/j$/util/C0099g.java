...
public class C0099g extends C0098f implements java.util.List, List {
    private static final long serialVersionUID = -7754090372962971524L;
    public final java.util.List c;

    public C0099g(java.util.List list) {
        super(list);
        this.c = list;
    }
    ...
    private Object readResolve() {
        ...
        return list instanceof RandomAccess ? new C0101i(list) : this;
    }
    ...
    public final void sort(java.util.Comparator comparator) {
        synchronized (this.b) {
            j$.desugar.sun.nio.fs.g.N(this.c, comparator);
        }
    }
    ...
    public java.util.List subList(int i, int i2) {
        C0099g c0099g;
        synchronized (this.b) {
            c0099g = new C0099g(this.c.subList(i, i2), this.b);
        }
        return c0099g;
    }
    ...
    public C0099g(java.util.List list, Serializable serializable) {
