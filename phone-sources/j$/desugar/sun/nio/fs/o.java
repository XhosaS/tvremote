...
public final class o implements Path {
    ...
    public o(AbstractC0071i abstractC0071i, String str, String str2, String str3) {
        this(abstractC0071i, str.startsWith("/"), str.isEmpty() ? Collections.singletonList("") : (List) DesugarArrays.stream(h.split(str)).filter(new n(0)).collect(new C0121f(new n(13), new n(14), new n(15), new n(16), Collectors.b)), str2, str3);
    }
    ...
    public final M c(P p, D[] dArr, G... gArr) {
    ...
    @Override // j$.nio.file.Path
    public final AbstractC0071i getFileSystem() {
        return this.a;
    }
    ...
    public final Path k(LinkOption[] linkOptionArr) {
        ...
        abstractC0071i.i().a(this, EnumC0064b.READ);
        return Arrays.asList(linkOptionArr).contains(LinkOption.NOFOLLOW_LINKS) ? toAbsolutePath() : new o(abstractC0071i, toFile().getCanonicalPath(), this.e, this.f);
    }
    ...
    public final boolean startsWith(String str) {
        return q(new o(this.a, str, this.e, this.f));
    }
    ...
    public o(AbstractC0071i abstractC0071i, boolean z, List list, String str, String str2) {
