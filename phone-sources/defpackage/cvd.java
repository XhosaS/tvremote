...
public final class cvd {
    ...
    public static boolean a(cvc cvcVar, View view, Window.Callback callback, KeyEvent keyEvent) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException, InvocationTargetException {
        if (cvcVar == null) {
            return false;
        }
        if (Build.VERSION.SDK_INT >= 28) {
            return cvcVar.superDispatchKeyEvent(keyEvent);
        }
        if (!(callback instanceof Activity)) {
            if (!(callback instanceof Dialog)) {
                return (view != null && cww.u(view, keyEvent)) || cvcVar.superDispatchKeyEvent(keyEvent);
            }
