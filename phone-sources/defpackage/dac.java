...
final class dac implements ActionMode.Callback {
    ...
    public dac(ActionMode.Callback callback, TextView textView) {
        this.a = callback;
        this.b = textView;
    }

    private static final Intent a() {
        return new Intent().setAction("android.intent.action.PROCESS_TEXT").setType(WebViewActivity.URL_MIME_TYPE);
    }
