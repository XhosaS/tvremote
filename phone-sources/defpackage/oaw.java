...
public final class oaw {
    ...
    public static String b(Context context, int i) {
        ...
        if (i == 2) {
            return ocp.e(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, strA);
        }
        if (i == 3) {
    ...
    public static String c(Context context, int i) {
        ...
        switch (i) {
            ...
            case 19:
            default:
                Log.e("GoogleApiAvailability", a.cf(i, "Unexpected error code "));
                return null;
            case 16:
    ...
    public static String e(Context context, String str) {
        ...
        ko koVar = a;
        synchronized (koVar) {
            Locale localeF = crh.l(context.getResources().getConfiguration()).f(0);
            if (!localeF.equals(b)) {
                koVar.clear();
                b = localeF;
            }
            String str2 = (String) koVar.get(str);
            if (str2 != null) {
                return str2;
            }
            boolean z = nwb.a;
            ...
            if (identifier == 0) {
                Log.w("GoogleApiAvailability", a.cr(str, "Missing resource: "));
                return null;
            }
            String string = resourcesForApplication.getString(identifier);
            if (TextUtils.isEmpty(string)) {
                Log.w("GoogleApiAvailability", a.cr(str, "Got empty resource: "));
                return null;
            }
            a.put(str, string);
            return string;
