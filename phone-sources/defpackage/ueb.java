...
public final class ueb {
    private static final tsa a = new trs('.');
    private static final tsa b = new trs(':');
    ...
    public static InetAddress a(String str) {
        xzg xzgVar = new xzg();
        byte[] bArrB = b(str, xzgVar);
        if (bArrB != null) {
            return d(bArrB, (String) xzgVar.a);
        }
    ...
    */
    public static byte[] b(java.lang.String r13, defpackage.xzg r14) {
        /*
            Method dump skipped, instructions count: 353
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ueb.b(java.lang.String, xzg):byte[]");
    }
    ...
    private static InetAddress d(byte[] bArr, String str) throws SocketException, UnknownHostException {
        try {
            ...
            sij.o(byAddress instanceof Inet6Address, "Unexpected state, scope should only appear for ipv6");
            ...
            try {
                ...
                throw new IllegalArgumentException(a.cr(str, "No such interface: "), e);
            }
