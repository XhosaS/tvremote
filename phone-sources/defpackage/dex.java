...
public final class dex extends ddj implements RandomAccess, deo, dfo {
    public int a;
    private long[] b;

    static {
        new dex(new long[0], 0, false);
    }
    ...
    public final boolean addAll(Collection<? extends Long> collection) {
        ...
        collection.getClass();
        if (!(collection instanceof dex)) {
            return super.addAll(collection);
        }
        dex dexVar = (dex) collection;
        int i = dexVar.a;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(dexVar.b, 0, this.b, this.a, dexVar.a);
        this.a = i3;
        this.modCount++;
        return true;
    }
    ...
    public final /* bridge */ /* synthetic */ deo d(int i) {
        if (i >= this.a) {
            return new dex(Arrays.copyOf(this.b, i), this.a, true);
        }
    ...
    private dex(long[] jArr, int i, boolean z) {
        super(z);
        this.b = jArr;
        this.a = i;
    }
