...
final class vwn {
    ...
    static String d(ByteBuffer byteBuffer, int i, int i2) {
        if (byteBuffer.hasArray()) {
            return vxr.n(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        }
        return byteBuffer.isDirect() ? vxr.m(byteBuffer, i, i2) : vxr.m(byteBuffer, i, i2);
    }
    ...
    */
    static boolean e(byte[] r6, int r7, int r8) {
        /*
        L0:
            if (r7 >= r8) goto L9
            r0 = r6[r7]
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vwn.e(byte[], int, int):boolean");
    }
}
