            ...
            if (bArr.length - i4 >= i) {
                ...
                while (i5 < length) {
                    ...
                    if (cCharAt2 < c && j4 < j5) {
                        ...
                        if ((cCharAt2 >= 55296 && cCharAt2 <= 57343) || j4 > j5 - 3) {
                            ...
                            if (i6 != length) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    ...
                                    dra.k(bArr, j4, (byte) ((codePoint >>> 18) | 240));
                                    c2 = 128;
                                    dra.k(bArr, j4 + j6, (byte) (((codePoint >>> 12) & 63) | 128));
                                    long j7 = j4 + 3;
                                    dra.k(bArr, j4 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                    j4 += 4;
                                    dra.k(bArr, j7, (byte) ((codePoint & 63) | 128));
                                    i5 = i6;
                                } else {
                                    i5 = i6;
                                }
                            }
                            throw new drd(i5 - 1, length);
                        }
                        dra.k(bArr, j4, (byte) ((cCharAt2 >>> '\f') | 480));
                        long j8 = j4 + 2;
                        j2 = j3;
                        dra.k(bArr, j4 + j6, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                        j4 += 3;
                        dra.k(bArr, j8, (byte) ((cCharAt2 & '?') | 128));
                        c2 = 128;
                        i5++;
                        i4 = i2;
                        c = c2;
                        ...
                        long j9 = j4 + j6;
                        dra.k(bArr, j4, (byte) ((cCharAt2 >>> 6) | 960));
                        j4 += 2;
                        dra.k(bArr, j9, (byte) ((cCharAt2 & '?') | c));
                        j2 = j3;
                    }
                    c2 = c;
                    i5++;
