...
public final class zwe implements PrivateKey, Key {
    private static final long serialVersionUID = 1;
    private transient zrq a;
    private transient zjo b;

    public zwe(zlq zlqVar) {
        a(zlqVar);
    }

    private final void a(zlq zlqVar) {
        this.b = zlqVar.b;
        this.a = (zrq) vxr.bJ(zlqVar);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zwe) {
            return Arrays.equals(this.a.a(), ((zwe) obj).a.a());
        }
        return false;
    }
