...
public final class jcu implements ekm {
    ...
    public final void ar(ekl eklVar, evq evqVar, evv evvVar, IOException iOException) {
        if (this.a != 0) {
            ...
            ((tug) ((tug) jcm.a.f().h(tvo.a, "[GTVM-Kinetoscope]")).i(iOException).j("com/google/android/apps/googletv/app/player/TrailerPlayerFragment$playerAnalyticsListener$1", "onLoadError", 286, "TrailerPlayerFragment.kt")).s("Playback Error");
        } else {
            iOException.getClass();
            ((tug) ((tug) jdd.a.f().h(tvo.a, "[GTVM-Kinetoscope]")).i(iOException).j("com/google/android/apps/googletv/app/player/TvodPlayerFragment$playerAnalyticsListener$1", "onLoadError", 666, "TvodPlayerFragment.kt")).s("[Kinetoscope] Playback Error");
        }
    }
    ...
    @Override // defpackage.ekm
    public final /* synthetic */ void i(ekl eklVar, evv evvVar) {
    }
    ...
    @Override // defpackage.ekm
    public final /* synthetic */ void x(ekl eklVar, eah eahVar) {
    }
    ...
    @Override // defpackage.ekm
    public final /* synthetic */ void z(ekl eklVar, ean eanVar, ean eanVar2, int i) {
    }
}
