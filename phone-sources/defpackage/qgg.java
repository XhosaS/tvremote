...
public final class qgg implements qeq {
    private static final tvn a = tvn.n("GnpSdk");
    private final tst b;
    private final unc c;

    public qgg(unc uncVar, tst tstVar) {
        this.c = uncVar;
        this.b = tstVar;
    }
    ...
    */
    public final java.lang.Object b(android.content.Intent r2, defpackage.qdo r3, long r4, defpackage.yih r6) {
        /*
            r1 = this;
            boolean r2 = r6 instanceof defpackage.qgf
            if (r2 == 0) goto L13
            r2 = r6
            qgf r2 = (defpackage.qgf) r2
            int r3 = r2.c
        ...
        L38:
            ...
            if (r3 == r4) goto L71
        L4b:
            tvn r3 = defpackage.qgg.a
            tuv r3 = r3.l()
            java.lang.String r5 = "Syncing registration status due to device restart."
            r3.s(r5)
            unc r3 = r1.c     // Catch: java.lang.Exception -> L2a
            vmd r5 = defpackage.vmd.DEVICE_START     // Catch: java.lang.Exception -> L2a
        ...
        L71:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.qgg.b(android.content.Intent, qdo, long, yih):java.lang.Object");
    }
    ...
    public final void c(Intent intent, qdo qdoVar, long j) throws Throwable {
        intent.getClass();
        qdoVar.getClass();
        ykr.n(yim.a, new dsk(this, intent, qdoVar, j, (yih) null, 6));
    }

    @Override // defpackage.qeq
    public final boolean d(Intent intent) {
        return yks.e("android.intent.action.BOOT_COMPLETED", intent.getAction());
    }
}
