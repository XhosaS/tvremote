...
public class csx extends csv {
    ...
    public csx() throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        Method methodE;
    ...
    @Override // defpackage.csv, defpackage.ctc
    public final Typeface a(Context context, cty[] ctyVarArr, int i) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        Typeface typefaceC;
        ...
        if (!k()) {
            ...
            try {
                ...
                try {
                    Typeface typefaceBuild = new Typeface.Builder(parcelFileDescriptorOpenFileDescriptor.getFileDescriptor()).setWeight(ctyVarM.c).setItalic(ctyVarM.d).build();
        ...
        int length = ctyVarArr.length;
        int i2 = 0;
        boolean z = false;
        while (i2 < length) {
            cty ctyVar2 = ctyVarArr[i2];
            ByteBuffer byteBuffer = (ByteBuffer) mapUnmodifiableMap.get(ctyVar2.a);
            if (byteBuffer != null) {
                if (!((Boolean) this.d.invoke(objG, byteBuffer, Integer.valueOf(ctyVar2.b), null, Integer.valueOf(ctyVar2.c), Integer.valueOf(ctyVar2.d ? 1 : 0))).booleanValue()) {
                    h(objG);
                    return null;
                }
                z = true;
    ...
    @Override // defpackage.csv, defpackage.ctc
    public final Typeface b(Context context, cvw cvwVar, Resources resources, int i) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (!k()) {
            return super.b(context, cvwVar, resources, i);
        }
        Object objG = g();
        if (objG != null) {
            csi[] csiVarArr = (csi[]) cvwVar.a;
            int length = csiVarArr.length;
            int i2 = 0;
            while (i2 < length) {
                csi csiVar = csiVarArr[i2];
                Context context2 = context;
                if (!i(context2, objG, csiVar.a, csiVar.e, csiVar.b, csiVar.c ? 1 : 0, FontVariationAxis.fromFontVariationSettings(csiVar.d))) {
                    h(objG);
                    return null;
                }
                i2++;
