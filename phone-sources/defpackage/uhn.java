...
abstract class uhn extends AtomicReference implements Runnable {
    ...
    final void h() {
        ...
        if (runnable instanceof Thread) {
            ...
            uhmVar.a(Thread.currentThread());
            if (compareAndSet(runnable, uhmVar)) {
                try {
    ...
    public final String toString() {
        ...
        if (runnable == a) {
            str = "running=[DONE]";
        } else if (runnable instanceof uhm) {
