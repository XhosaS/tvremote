...
public enum tyc {
    ...
    static {
        ...
        for (tyc tycVar : values()) {
            if (map.put(Character.valueOf(tycVar.G), tycVar) != null) {
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(String.valueOf(tycVar))));
            }
        }
