...
public final class dra {
    ...
    static {
        ...
        if (unsafeH != null) {
            if (!doc.a()) {
                dqyVar = new dqy(unsafeH);
            } else if (zS) {
                dqyVar = new dqx(unsafeH);
            } else if (zS2) {
                dqyVar = new dqw(unsafeH);
            }
        }
        h = dqyVar;
        a = dqyVar == null ? false : dqyVar.h();
        b = dqyVar == null ? false : dqyVar.i();
        c = w(byte[].class);
        w(boolean[].class);
        x(boolean[].class);
        w(int[].class);
        ...
        x(Object[].class);
        Field fieldG = g();
        if (fieldG != null && dqyVar != null) {
            dqyVar.a.objectFieldOffset(fieldG);
        }
    ...
    public static Field g() {
        Field fieldW;
        if (doc.a() && (fieldW = a.W(Buffer.class, "effectiveDirectAddress")) != null) {
            return fieldW;
        }
    ...
    static Unsafe h() {
        try {
            return (Unsafe) AccessController.doPrivileged(new dqv(0));
    ...
    public static void i(Throwable th) {
        Logger logger = Logger.getLogger(dra.class.getName());
