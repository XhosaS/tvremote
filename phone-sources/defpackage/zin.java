...
public final class zin extends zjh implements zjp {
    final byte[] a;

    public zin(byte[] bArr) {
        this.a = bArr;
    }
    ...
    public final void c(zjf zjfVar, boolean z) throws IOException {
        zjfVar.j(z, 27, this.a);
    }

    @Override // defpackage.zjh
    public final boolean d(zjh zjhVar) {
        if (zjhVar instanceof zin) {
            return Arrays.equals(this.a, ((zin) zjhVar).a);
        }
        return false;
    }
