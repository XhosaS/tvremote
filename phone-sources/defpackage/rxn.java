...
public final class rxn implements Comparable {
    public final long a;
    ...
    public rxn(long j, String str, int i, long j2, Object obj) {
        a.H(((j > 0L ? 1 : (j == 0L ? 0 : -1)) == 0) == (str != null));
        this.a = j;
        this.b = str;
        this.c = i;
        this.d = j2;
        ...
        } else if ((obj instanceof byte[]) || (obj instanceof vsz)) {
            this.f = null;
        } else {
    ...
    public final Object a() {
        ...
        obj2.getClass();
        try {
            return obj2 instanceof byte[] ? (byte[]) obj2 : ((vsz) obj2).w();
        } catch (Throwable th) {
    ...
    public final boolean equals(Object obj) {
        ...
        rxn rxnVar = (rxn) obj;
        return this.a == rxnVar.a && Objects.equals(this.b, rxnVar.b);
    }
