...
public final class cqe extends ViewGroup.MarginLayoutParams {
    public int A;
    public int B;
    public int C;
    public int D;
    ...
    public final void a() {
        ...
        this.ae = true;
        this.af = true;
        if (!(this.av instanceof cph)) {
            this.av = new cph();
        }
        ((cph) this.av).c(this.Z);
    }
    ...
    */
    public final void resolveLayoutDirection(int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cqe.resolveLayoutDirection(int):void");
    }

    public cqe(Context context, AttributeSet attributeSet) throws NumberFormatException {
        ...
        this.av = new cpd();
        this.aw = false;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, cqr.b);
        int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = typedArrayObtainStyledAttributes.getIndex(i);
            int i2 = cqd.a.get(index);
            switch (i2) {
                case 1:
                ...
                default:
                    switch (i2) {
                        case R.styleable.AppCompatTheme_buttonBarPositiveButtonStyle /* 44 */:
                            cqn.k(this, typedArrayObtainStyledAttributes.getString(index));
                            break;
                        ...
                        default:
                            switch (i2) {
                                case R.styleable.AppCompatTheme_dividerHorizontal /* 64 */:
                                    cqn.j(this, typedArrayObtainStyledAttributes, index, 0);
                                    this.E = true;
                                    break;
                                case R.styleable.AppCompatTheme_dividerVertical /* 65 */:
                                    cqn.j(this, typedArrayObtainStyledAttributes, index, 1);
                                    this.F = true;
                                    break;
    ...
    public cqe(ViewGroup.LayoutParams layoutParams) {
        super(layoutParams);
        this.a = -1;
        this.b = -1;
        this.c = -1.0f;
        ...
        this.av = new cpd();
        this.aw = false;
        if (layoutParams instanceof cqe) {
            cqe cqeVar = (cqe) layoutParams;
            this.a = cqeVar.a;
            this.b = cqeVar.b;
            this.c = cqeVar.c;
            this.d = cqeVar.d;
