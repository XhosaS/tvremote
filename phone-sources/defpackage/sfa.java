...
public final class sfa {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof sfa) {
            sfa sfaVar = (sfa) obj;
            if (this.a.equals(sfaVar.a) && this.b.equals(sfaVar.b) && this.c.equals(sfaVar.c) && this.d == sfaVar.d && this.e == sfaVar.e && this.f.equals(sfaVar.f) && this.g == sfaVar.g && this.h == sfaVar.h) {
                return true;
            }
        }
        return false;
    ...
    public sfa(String str, String str2, String str3, int i, int i2, String str4, int i3, int i4) {
        this.a = str;
        this.b = str2;
        this.c = str3;
        this.d = i;
