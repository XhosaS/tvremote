...
public final class hgj implements hhc {
    private int a;
    ...
    public final /* bridge */ /* synthetic */ Object a(hhf hhfVar, float f) {
        ...
        while (hhfVar.n()) {
            arrayList.add(Float.valueOf((float) hhfVar.a()));
        }
        int i2 = 2;
        char c2 = 0;
        ...
        if (length == 0) {
            ...
            if (i10 != 0) {
                CopyOf = Arrays.copyOf((float[]) CopyOf, i9 - i10);
            }
        }
        float[] fArr5 = (float[]) CopyOf;
        ...
        while (i14 < length2) {
            ...
            if (iBinarySearch < 0 || iBinarySearch2 > 0) {
                ...
                if (iArr3.length < i2 || f7 == fArr4[c]) {
                    ...
                    int i18 = iArr3[i16];
                    float f12 = f11 / f10;
                    iArgb = Color.argb((int) (f8 * 255.0f), hjs.j(f12, Color.red(i18), Color.red(i17)), hjs.j(f12, Color.green(i18), Color.green(i17)), hjs.j(f12, Color.blue(i18), Color.blue(i17)));
                }
                iArr2[i14] = iArgb;
            } else {
                int i19 = ((int[]) obj)[iBinarySearch];
