...
public class dfw<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    public boolean c;
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        this.a.add(i, new dqn(this, comparable, obj, 1));
        return null;
    }
    ...
    public final Object d(int i) {
        ...
        if (!this.b.isEmpty()) {
            ...
            list.add(new dqn(this, (Comparable) entry.getKey(), entry.getValue(), 1));
            it.remove();
        }
        return obj;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int iA = a();
        if (iA != dfwVar.a()) {
            return entrySet().equals(dfwVar.entrySet());
        }
        for (int i = 0; i < iA; i++) {
            if (!e(i).equals(dfwVar.e(i))) {
                return false;
            }
        }
        if (iA != size) {
            return this.b.equals(dfwVar.b);
        }
        return true;
    }
