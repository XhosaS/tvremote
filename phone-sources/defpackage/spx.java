...
public final class spx extends dar {
    final /* synthetic */ BottomSheetBehavior a;

    public spx(BottomSheetBehavior bottomSheetBehavior) {
    ...
    */
    public final void d(android.view.View r6, float r7, float r8) {
        ...
        Ld8:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.spx.d(android.view.View, float, float):void");
    }
    ...
    public final int g(View view, int i) {
        return cmq.l(i, this.a.D(), h());
    }

    @Override // defpackage.dar
    public final int h() {
        BottomSheetBehavior bottomSheetBehavior = this.a;
        return bottomSheetBehavior.U() ? bottomSheetBehavior.B : bottomSheetBehavior.t;
    }
