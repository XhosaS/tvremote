...
public final class xxv {
    ...
    public static Long d(Map map, String str) throws NumberFormatException, ParseException {
        ...
        try {
            ...
            long jAn = Long.parseLong(strSubstring);
            ...
            try {
                ...
                if (jAn >= -315576000000L && jAn <= 315576000000L) {
                    long j3 = iCharAt;
                    if (j3 >= -999999999 && j3 < j2 && ((jAn >= 0 && iCharAt >= 0) || (jAn <= 0 && iCharAt <= 0))) {
                        long nanos = TimeUnit.SECONDS.toNanos(jAn);
                        long j4 = nanos + j3;
                ...
                throw new IllegalArgumentException(String.format("Duration is not valid. See proto definition for valid values. Seconds (%s) must be in range [-315,576,000,000, +315,576,000,000]. Nanos (%s) must be in range [-999,999,999, +999,999,999]. Nanos must have the same sign as seconds", Long.valueOf(jAn), Integer.valueOf(iCharAt)));
