...
public final class zwp implements PrivateKey, Key {
    private static final long serialVersionUID = 1;
    private transient zsu a;
    private transient zjo b;

    public zwp(zlq zlqVar) {
        a(zlqVar);
    }

    private final void a(zlq zlqVar) {
        this.b = zlqVar.b;
        this.a = (zsu) vxr.bJ(zlqVar);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zwp) {
            return Arrays.equals(this.a.a(), ((zwp) obj).a.a());
        }
        return false;
    }
