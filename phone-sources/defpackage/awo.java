...
final class awo implements yjz {
    ...
    public awo(bkp bkpVar, bol bolVar, long j, float f, qs qsVar, kw kwVar, boolean z, yjk yjkVar, float f2, yjz yjzVar) {
        this.a = bkpVar;
        this.b = bolVar;
        this.c = j;
        this.d = f;
    ...
    public final /* bridge */ /* synthetic */ Object a(Object obj, Object obj2) {
        ...
        if (baoVar.L(i != 2, iIntValue & 1)) {
            bkp bkpVar = this.a;
            bkp bkpVarBU = a.bU(hu.w(awq.a(ask.a(bkpVar), this.b, awq.b(this.c, this.d, baoVar), this.e, ((clx) baoVar.f(ccq.d)).cr(this.h)), this.j, atn.a(false, 0.0f, 7), this.f, null, this.g, 24));
            yjz yjzVar = this.i;
