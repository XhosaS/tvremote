...
public final class tde {
    private static final int[] a = {R.attr.theme, com.google.android.videos.R.attr.theme};
    private static final int[] b = {com.google.android.videos.R.attr.materialThemeOverlay};
    ...
    public static Context b(Context context, AttributeSet attributeSet, int i, int i2, int[] iArr) {
        ...
        boolean z = (context instanceof hc) && ((hc) context).a == i3;
        if (i3 == 0 || z) {
            return context;
        }
        hc hcVar = new hc(context, i3);
        int[] iArrC = c(context, attributeSet, iArr, i, i2);
        int length = iArrC.length;
        for (int i4 = 0; i4 < length; i4 = 1) {
            int i5 = iArrC[0];
            if (i5 != 0) {
                hcVar.getTheme().applyStyle(i5, true);
            }
        }
        ...
        if (resourceId != 0) {
            hcVar.getTheme().applyStyle(resourceId, true);
        }
        return hcVar;
    }
