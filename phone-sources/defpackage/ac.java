...
public final class ac extends ViewGroup.MarginLayoutParams {
    public float A;
    public float B;
    public int C;
    public int D;
    ...
    public ac(Context context, AttributeSet attributeSet) throws NumberFormatException {
        int i;
        ...
        this.X = 0.5f;
        this.Y = new am();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, af.a);
        ...
        for (int i2 = 0; i2 < indexCount; i2++) {
            ...
            if (index == 84) {
                ...
                this.K = typedArrayObtainStyledAttributes.getDimensionPixelOffset(R.styleable.AppCompatTheme_textAppearanceListItem, this.K);
            } else if (index == 104) {
                this.L = typedArrayObtainStyledAttributes.getDimensionPixelOffset(R.styleable.AppCompatTheme_textAppearanceListItemSecondary, this.L);
            } else if (index == 72) {
                ...
                this.r = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.AppCompatTheme_textColorSearchUrl, this.r);
            } else if (index == 109) {
                this.s = typedArrayObtainStyledAttributes.getDimensionPixelSize(109, this.s);
            } else if (index == 106) {
                this.t = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.AppCompatTheme_textAppearancePopupMenuHeader, this.t);
            } else if (index == 110) {
                this.u = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.AppCompatTheme_textColorAlertDialogListItem, this.u);
            } else if (index == 107) {
                this.v = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle, this.v);
            } else if (index == 80) {
