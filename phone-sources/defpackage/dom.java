...
final class dom extends doo {
    ...
    public dom(byte[] bArr) {
        this.i = bArr;
    }

    public final byte a() throws dpm {
        int i = this.c;
        if (i == this.a) {
    ...
    public final void l(int i) throws dpm {
        if (i >= 0) {
            int i2 = this.a;
            int i3 = this.c;
            if (i <= i2 - i3) {
