...
public final class yic implements Comparator, j$.util.Comparator {
    private final /* synthetic */ int c;
    public static final yic b = new yic(1);
    public static final yic a = new yic(0);
    ...
    public final /* synthetic */ java.util.Comparator thenComparing(Function function) {
        return this.c != 0 ? Comparator.CC.$default$thenComparing(this, function) : Comparator.CC.$default$thenComparing(this, function);
    }
