...
public final class zxj {
    ...
    public final zxj e(int i) {
        if (!this.a.c(i)) {
            throw new ArithmeticException("Not an element of the finite field this polynomial is defined over.");
        }
        return new zxj(this.a, h(this.c, i));
    }

    public final boolean equals(Object obj) {
        if (obj != null && (obj instanceof zxj)) {
            zxj zxjVar = (zxj) obj;
            if (this.a.equals(zxjVar.a) && this.b == zxjVar.b) {
                int[] iArr = this.c;
                int[] iArr2 = zxjVar.c;
                int iA = a(iArr);
                if (iA == a(iArr2)) {
    ...
    public final void f(zxj zxjVar) {
        this.c = i(this.c, zxjVar.c);
        j();
    }
    ...
    public zxj(zxf zxfVar, byte[] bArr) {
        this.a = zxfVar;
        int i = 8;
        int i2 = 1;
        while (zxfVar.a > i) {
    ...
    public zxj(zxf zxfVar, int[] iArr) {
        int[] iArrBp;
        this.a = zxfVar;
        int iA = a(iArr);
        if (iA == -1) {
