...
public final class ifl {
    ...
    private static final ClassLoader b = ifl.class.getClassLoader();
    ...
    public static void b(Parcel parcel) {
        ...
        if (iDataAvail > 0) {
            throw new BadParcelableException(a.cf(iDataAvail, "Parcel data not fully consumed, unread size: "));
        }
    }
