...
public final class hsl extends FilterInputStream implements InputStreamRetargetInterface {
    ...
    public hsl(InputStream inputStream, hok hokVar) {
        super(inputStream);
        this.d = -1;
        this.f = hokVar;
        this.a = (byte[]) hokVar.a(65536, byte[].class);
    }
    ...
    */
    private final int c(java.io.InputStream r6, byte[] r7) throws java.io.IOException {
        ...
        L5f:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.hsl.c(java.io.InputStream, byte[]):int");
    }
    ...
    public final synchronized void reset() {
        ...
        int i = this.d;
        if (i == -1) {
            throw new hsk("Mark has been invalidated, pos: " + this.e + " markLimit: " + this.c);
        }
        this.e = i;
    }
    ...
    */
    public final synchronized int read(byte[] r6, int r7, int r8) {
        ...
        L84:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.hsl.read(byte[], int, int):int");
    }
}
