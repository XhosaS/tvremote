...
public final class zpk extends BasicPermission {
    ...
    public zpk(String str) {
        super("BC", str);
        this.a = str;
        StringTokenizer stringTokenizer = new StringTokenizer(zxr.b(str), " ,");
        int i = 0;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zpk) {
            zpk zpkVar = (zpk) obj;
            if (this.b == zpkVar.b && getName().equals(zpkVar.getName())) {
                return true;
            }
        }
        return false;
    ...
    public final boolean implies(Permission permission) {
        if (!(permission instanceof zpk) || !getName().equals(permission.getName())) {
            return false;
        }
        int i = this.b;
        int i2 = ((zpk) permission).b;
        return (i & i2) == i2;
    }
}
