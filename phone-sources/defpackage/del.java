...
public final class del extends ddj implements RandomAccess, deo, dfo {
    public int a;
    private int[] b;

    static {
        new del(new int[0], 0, false);
    }
    ...
    public final boolean addAll(Collection<? extends Integer> collection) {
        ...
        collection.getClass();
        if (!(collection instanceof del)) {
            return super.addAll(collection);
        }
        del delVar = (del) collection;
        int i = delVar.a;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(delVar.b, 0, this.b, this.a, delVar.a);
        this.a = i3;
        this.modCount++;
        return true;
    }
    ...
    public final /* bridge */ /* synthetic */ deo d(int i) {
        if (i >= this.a) {
            return new del(Arrays.copyOf(this.b, i), this.a, true);
        }
    ...
    private del(int[] iArr, int i, boolean z) {
        super(z);
        this.b = iArr;
        this.a = i;
    }
