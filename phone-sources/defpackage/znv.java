...
public final class znv extends zns {
    private int a;
    private int b;
    private int c;
    private int d;
    ...
    public final int a(byte[] bArr, int i) {
        f();
        vxr.aU(this.a, bArr, i);
        vxr.aU(this.b, bArr, i + 4);
        vxr.aU(this.c, bArr, i + 8);
        vxr.aU(this.d, bArr, i + 12);
        vxr.aU(this.e, bArr, i + 16);
        j();
        return 20;
    }
