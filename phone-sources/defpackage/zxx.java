...
public final class zxx {
    ...
    public static byte[] c(String str) {
        try {
            ...
            throw new zxu("exception decoding Hex string: ".concat(String.valueOf(e.getMessage())), e);
        }
    }
    ...
    public static byte[] e(byte[] bArr, int i, int i2) throws IOException {
        ...
        try {
            ...
            throw new zxw("exception encoding Hex string: ".concat(String.valueOf(e.getMessage())), e);
        }
    }
