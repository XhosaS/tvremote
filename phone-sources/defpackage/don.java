...
public final class don extends doo {
    ...
    public don(InputStream inputStream) {
        byte[] bArr = dpk.b;
        this.i = inputStream;
    ...
    private final boolean A(int i) throws dpm {
        int i2 = this.c;
        int i3 = i2 + i;
        int i4 = this.b;
        if (i3 <= i4) {
    ...
    private static int y(InputStream inputStream, byte[] bArr, int i, int i2) throws dpm {
        try {
    ...
    @Override // defpackage.doo
    public final int e(int i) throws dpm {
        if (i < 0) {
    ...
    public final int h() throws dpm {
        ...
        throw new dpm("Protocol message contained an invalid tag (zero).");
    }
    ...
    @Override // defpackage.doo
    public final void j(int i) throws dpm {
        if (this.k != i) {
    ...
    @Override // defpackage.doo
    public final boolean o(int i) throws dpm {
        int iB = dri.b(i);
        int i2 = 0;
        if (iB == 0) {
            if (this.b - this.c < 10) {
                ...
                throw new dpm("CodedInputStream encountered a malformed varint.");
            }
            while (i2 < 10) {
                byte[] bArr = this.a;
                int i3 = this.c;
    ...
    */
    public final long q() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.don.q():long");
    }

    final long r() throws dpm {
        long j = 0;
    ...
    public final void t(int i) {
        ...
        throw new dpm("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit.");
    }

    public final void u(int i) throws dpm {
        int i2 = this.b;
        int i3 = this.c;
        int i4 = i2 - i3;
        if (i <= i4 && i >= 0) {
