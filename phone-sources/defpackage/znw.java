...
public final class znw extends zns implements znp {
    ...
    public final int a(byte[] bArr, int i) {
        f();
        vxr.aU(this.b, bArr, i);
        vxr.aU(this.c, bArr, i + 4);
        vxr.aU(this.d, bArr, i + 8);
        vxr.aU(this.e, bArr, i + 12);
        vxr.aU(this.f, bArr, i + 16);
        vxr.aU(this.g, bArr, i + 20);
        vxr.aU(this.h, bArr, i + 24);
        vxr.aU(this.i, bArr, i + 28);
        j();
        return 32;
    }
