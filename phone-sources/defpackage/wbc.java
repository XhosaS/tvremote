...
public final class wbc implements uqs {
    public final ImmutableSet d;
    private final ImmutableList h;
    private final ImmutableMap i;
    private static final rmp e = new rmp("google.internal.play.movies.dfe.v1beta.pagination.PaginationService");
    public static final rmp a = new rmp("google.internal.play.movies.dfe.v1beta.pagination.PaginationService.");
    private static final rmp f = new rmp("google.internal.play.movies.dfe.v1beta.pagination.PaginationService/");
    public static final uqr b = new vgj(12, (float[][]) null);
    public static final wbc c = new wbc();
    ...
    private wbc() {
        ...
        builder3.put("FetchByToken", uqrVar);
