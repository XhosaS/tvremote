...
public final class wfu {
    ...
    static {
        ...
        double dE = (wga.e(50.0d) * 63.66197723675813d) / 100.0d;
        double d13 = d2 + d4 + d6;
        double dE2 = vyf.e(0.0d, 1.0d, 1.0d - (Math.exp(((-dE) - 42.0d) / 92.0d) * 0.2777777777777778d));
        double d14 = d7 + d8 + d9;
        double d15 = d10 + d11 + d12;
        double[] dArr6 = {(((100.0d / d13) * dE2) + 1.0d) - dE2, (((100.0d / d14) * dE2) + 1.0d) - dE2, (((100.0d / d15) * dE2) + 1.0d) - dE2};
        double d16 = 5.0d * dE;
        double d17 = 1.0d / (d16 + 1.0d);
        double d18 = d17 * d17 * d17 * d17;
        double d19 = 1.0d - d18;
        double dCbrt = d19 * 0.1d * d19 * Math.cbrt(d16);
        double dE3 = wga.e(dMax) / dArr[1];
        double dSqrt = Math.sqrt(dE3) + 1.48d;
        double dPow = 0.725d / Math.pow(dE3, 0.2d);
        ...
        double d25 = dArr8[0];
        a = new wfu(dE3, (d25 + d25 + dArr8[1] + (d24 * 0.05d)) * dPow, dPow, dPow, vyf.f(0.59d, 0.69d, 0.9999999999999998d), dArr6, d20, Math.pow(d20, 0.25d), dSqrt);
    }

    private wfu(double d, double d2, double d3, double d4, double d5, double[] dArr, double d6, double d7, double d8) {
        this.f = d;
        this.b = d2;
        this.c = d3;
        this.d = d4;
