...
public final class zwn implements PrivateKey, Key {
    private static final long serialVersionUID = 1;
    private transient zsi a;
    private transient zjo b;

    public zwn(zlq zlqVar) {
        a(zlqVar);
    }

    private final void a(zlq zlqVar) {
        this.b = zlqVar.b;
        this.a = (zsi) vxr.bJ(zlqVar);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zwn) {
            return Arrays.equals(this.a.a(), ((zwn) obj).a.a());
        }
        return false;
    }
