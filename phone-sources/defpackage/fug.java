...
public final class fug {
    ...
    public static fug l(Bundle bundle) {
        if (bundle != null) {
            return new fug(bundle);
        }
        return null;
    }
    ...
    public final String toString() {
        ...
        sb.append(bundle.getInt("maxClientVersion", ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
