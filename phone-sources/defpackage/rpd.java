...
public final class rpd {
    ...
    public static rpe a(Context context, String str) {
        try {
            Trace.beginSection(str);
            Object systemService = context.getSystemService("activity");
            systemService.getClass();
            List<ActivityManager.RunningAppProcessInfo> runningAppProcesses = ((ActivityManager) systemService).getRunningAppProcesses();
            return runningAppProcesses == null ? new rpe(false, ImmutableList.of()) : new rpe(true, ImmutableList.copyOf((Collection) runningAppProcesses));
        } finally {
            Trace.endSection();
        }
    }
    ...
    */
    public static java.lang.String b() throws java.lang.Throwable {
        /*
            java.lang.String r0 = defpackage.rpd.c
            if (r0 == 0) goto L5
            goto L40
        L5:
        ...
        Ld:
            ...
            java.lang.String r0 = defpackage.a.cd(r0, r4, r5)     // Catch: java.lang.Throwable -> L31 java.io.IOException -> L38
        ...
        L40:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.rpd.b():java.lang.String");
    }
    ...
    public static boolean d(Context context, rpe rpeVar) {
        if (!rpeVar.a) {
            return false;
        }
        ImmutableList<ActivityManager.RunningAppProcessInfo> immutableListA = rpeVar.a();
        String packageName = context.getPackageName();
        String strValueOf = String.valueOf(packageName);
        for (ActivityManager.RunningAppProcessInfo runningAppProcessInfo : immutableListA) {
