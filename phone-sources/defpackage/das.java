...
public final class das {
    private static final Interpolator f = new glm(1);
    public int a;
    public final int b;
    public View d;
    ...
    public int c = -1;
    private final Runnable w = new caw(this, 12, null);

    private das(Context context, ViewGroup viewGroup, dar darVar) {
        a.ar(darVar, "Callback may not be null");
        this.v = viewGroup;
        this.t = darVar;
        ...
        this.e = f;
        this.s = new OverScroller(context, new daq(this));
    }

    public static das b(ViewGroup viewGroup, dar darVar) {
        return new das(viewGroup.getContext(), viewGroup, darVar);
    }
    ...
    private final void p() {
        ...
        float xVelocity = this.o.getXVelocity(this.c);
        float f3 = this.q;
        o(v(xVelocity, f3, f2), v(this.o.getYVelocity(this.c), f3, f2));
    }
    ...
    private final void r(float f2, float f3, int i) {
        ...
        int i5 = this.r;
        int i6 = i3 < viewGroup.getLeft() + i5 ? 1 : 0;
    ...
    private final boolean t(View view, float f2, float f3) {
        ...
        dar darVar = this.t;
        boolean z = darVar.a(view) > 0;
        boolean z2 = darVar.h() > 0;
        if (!z || !z2) {
    ...
    public final void d(View view, int i) {
        ...
        ViewGroup viewGroup = this.v;
        if (parent != viewGroup) {
            throw new IllegalArgumentException(a.cj(viewGroup, "captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (", ")"));
        }
        this.d = view;
        this.c = i;
        this.t.b(view, i);
    ...
    public final boolean g(int i, int i2, int i3, int i4) {
        ...
        float f5 = f4 / f3;
        float fM = m(i6, iW2, this.t.h());
        this.e = f;
        this.s.startScroll(left, top, i7, i6, (int) ((m(i7, iW, r13.a(view)) * f2) + (fM * f5)));
        f(2);
        return true;
    }
    ...
    */
    public final boolean j(android.view.MotionEvent r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.das.j(android.view.MotionEvent):boolean");
    }
