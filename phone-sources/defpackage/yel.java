...
final class yel {
    ...
    public static final yel a = new yel();

    private yel() {
        for (int i = 0; i < 256; i++) {
            int i2 = c[i];
            int i3 = d[i];
            zfd zfdVar = new zfd(i, i3);
            zfd zfdVar2 = this.b;
            while (i3 > 8) {
                i3 -= 8;
                int i4 = (i2 >>> i3) & 255;
                ...
                zfd[] zfdVarArr = (zfd[]) obj;
                zfd zfdVar3 = zfdVarArr[i4];
                if (zfdVar3 == null) {
                    zfdVar3 = new zfd();
                    zfdVarArr[i4] = zfdVar3;
                }
                zfdVar2 = zfdVar3;
            }
            int i5 = 8 - i3;
