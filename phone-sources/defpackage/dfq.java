...
public final class dfq<E> extends ddj<E> implements RandomAccess {
    public static final dfq a = new dfq(new Object[0], 0, false);
    private Object[] b;
    private int c;
    ...
    public final /* bridge */ /* synthetic */ deo d(int i) {
        if (i >= this.c) {
            return new dfq(Arrays.copyOf(this.b, i), this.c, true);
        }
    ...
    private dfq(Object[] objArr, int i, boolean z) {
        super(z);
        this.b = objArr;
        this.c = i;
    }
